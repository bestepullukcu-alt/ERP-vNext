...
interface OfferManagementDao {
     ...
     */
    @Query("SELECT * FROM offer_management WHERE sync_status != :synced ORDER BY code ASC")
    suspend fun getUnsynced(synced: SyncStatus = SyncStatus.SYNCED): List<OfferManagementEntity>
