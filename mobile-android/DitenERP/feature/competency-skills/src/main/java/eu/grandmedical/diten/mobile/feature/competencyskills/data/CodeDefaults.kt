...
/**
 * Client-side defaults for a new competency-skills record.
 *
 * The auto-generated [defaultCode] must be MARKER-SAFE: the backend rejects
 * certain forbidden marker substrings in text fields (e.g. "score", "rating",
 * "rank", "calibration"), so the code is built only from a fixed safe prefix, the
...
object CodeDefaults {
     ...
     * `CS-260911-K7QM`. Two calls differ (random suffix).
     */
    fun defaultCode(
