...
import eu.grandmedical.diten.mobile.feature.competencyskills.data.mapper.toDomain
import eu.grandmedical.diten.mobile.feature.competencyskills.data.mapper.toEntity
import eu.grandmedical.diten.mobile.feature.competencyskills.data.mapper.toListItem
 ...
 */
class CompetencySkillsRepositoryImpl @Inject constructor(
    private val dao: CompetencySkillsDao,
    private val api: CompetencySkillsApi,
    private val safeApiCaller: SafeApiCaller,
    private val scopeProvider: CompetencySkillsScopeProvider,
    private val syncScheduler: SyncScheduler,
) : CompetencySkillsRepository {

    override fun observeList(): Flow<List<CompetencySkillsListItem>> = flow {
    ...
    override fun observe(id: String): Flow<CompetencySkillsReadiness?> =
    ...
    override suspend fun evaluate(id: String): UiResult<CompetencySkillsReadiness> {
        val scope = scopeProvider.currentScope()
            ?: return UiResult.Error("No active legal entity selected.")
