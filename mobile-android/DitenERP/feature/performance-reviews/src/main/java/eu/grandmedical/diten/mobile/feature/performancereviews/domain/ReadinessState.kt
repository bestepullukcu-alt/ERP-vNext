...
/**
 * The HCM readiness state, mirroring the backend `PerformanceReviewReadinessState`
 * enum.
 *
 ...
 *
 * IMPORTANT — the int codes are MEASURED from the performance-reviews backend and
 * DIFFER from the applicant-intake pilot's ordering (there Deferred=1, Ready=2).
 * Here the backend fixes:
