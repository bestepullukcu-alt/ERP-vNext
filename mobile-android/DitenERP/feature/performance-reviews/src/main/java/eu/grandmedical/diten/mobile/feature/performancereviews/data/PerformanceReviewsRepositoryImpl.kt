...
import eu.grandmedical.diten.mobile.feature.performancereviews.data.mapper.toDomain
import eu.grandmedical.diten.mobile.feature.performancereviews.data.mapper.toEntity
import eu.grandmedical.diten.mobile.feature.performancereviews.data.mapper.toListItem
 ...
 */
class PerformanceReviewsRepositoryImpl @Inject constructor(
    private val dao: PerformanceReviewsDao,
    private val api: PerformanceReviewsApi,
    private val safeApiCaller: SafeApiCaller,
    private val scopeProvider: PerformanceReviewsScopeProvider,
    private val syncScheduler: SyncScheduler,
) : PerformanceReviewsRepository {

    override fun observeList(): Flow<List<PerformanceReviewsListItem>> = flow {
    ...
    override fun observe(id: String): Flow<PerformanceReviewsReadiness?> =
    ...
    override suspend fun evaluate(id: String): UiResult<PerformanceReviewsReadiness> {
        val scope = scopeProvider.currentScope()
            ?: return UiResult.Error("No active legal entity selected.")
