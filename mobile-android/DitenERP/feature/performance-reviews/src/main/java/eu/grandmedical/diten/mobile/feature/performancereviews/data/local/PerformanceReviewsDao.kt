...
interface PerformanceReviewsDao {
     ...
     */
    @Query("SELECT * FROM performance_reviews WHERE sync_status != :synced ORDER BY code ASC")
    suspend fun getUnsynced(synced: SyncStatus = SyncStatus.SYNCED): List<PerformanceReviewsEntity>
