...
import eu.grandmedical.diten.mobile.feature.compensationbenefits.data.mapper.toDomain
import eu.grandmedical.diten.mobile.feature.compensationbenefits.data.mapper.toEntity
import eu.grandmedical.diten.mobile.feature.compensationbenefits.data.mapper.toListItem
 ...
 */
class CompensationBenefitsRepositoryImpl @Inject constructor(
    private val dao: CompensationBenefitsDao,
    private val api: CompensationBenefitsApi,
    private val safeApiCaller: SafeApiCaller,
    private val scopeProvider: CompensationBenefitsScopeProvider,
    private val syncScheduler: SyncScheduler,
) : CompensationBenefitsRepository {

    override fun observeList(): Flow<List<CompensationBenefitsListItem>> = flow {
    ...
    override fun observe(id: String): Flow<CompensationBenefitsReadiness?> =
    ...
    override suspend fun evaluate(id: String): UiResult<CompensationBenefitsReadiness> {
        val scope = scopeProvider.currentScope()
            ?: return UiResult.Error("No active legal entity selected.")
