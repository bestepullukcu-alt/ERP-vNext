...
/**
 * Contributes the Compensation & Benefits feature to the app shell through the
...
object CompensationBenefitsFeatureModule {

    /** Menu half: the permission-gated Home entry. */
    @Provides
    @IntoSet
    fun provideFeatureEntry(): FeatureEntry = CompensationBenefitsFeature.entry
    ...
    fun provideFeatureNavGraph(): FeatureNavGraph =
        FeatureNavGraph { builder, navController ->
            CompensationBenefitsFeature.register(builder, navController)
        }
}
