...
interface ApplicantIntakeDao {
     ...
     */
    @Query("SELECT * FROM applicant_intake WHERE sync_status != :synced ORDER BY code ASC")
    suspend fun getUnsynced(synced: SyncStatus = SyncStatus.SYNCED): List<ApplicantIntakeEntity>
