...
/**
 * The HCM readiness state, mirroring the backend `EmployeeOnboardingReadinessState`
 * enum.
 *
 ...
 * (Note: this module's Ready/Deferred codes differ from applicant-intake's — the
 * backing enum declares Ready before Deferred here.)
 */
