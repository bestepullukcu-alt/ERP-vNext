...
/**
 * The HCM readiness state, mirroring the backend `LearningTrainingReadinessState`
 * enum.
 *
 ...
 *
 * ⚠️ The int codes are fixed by THIS module's backend enum and must never be
 * reordered. Unlike the applicant-intake pilot (`Deferred=1, Ready=2`), the
 * learning-training service uses:
