...
import eu.grandmedical.diten.mobile.feature.learningtraining.data.mapper.toDomain
import eu.grandmedical.diten.mobile.feature.learningtraining.data.mapper.toEntity
import eu.grandmedical.diten.mobile.feature.learningtraining.data.mapper.toListItem
 ...
 */
class LearningTrainingRepositoryImpl @Inject constructor(
    private val dao: LearningTrainingDao,
    private val api: LearningTrainingApi,
    private val safeApiCaller: SafeApiCaller,
    private val scopeProvider: LearningTrainingScopeProvider,
    private val syncScheduler: SyncScheduler,
) : LearningTrainingRepository {

    override fun observeList(): Flow<List<LearningTrainingListItem>> = flow {
    ...
    override fun observe(id: String): Flow<LearningTrainingReadiness?> =
    ...
    override suspend fun evaluate(id: String): UiResult<LearningTrainingReadiness> {
        val scope = scopeProvider.currentScope()
            ?: return UiResult.Error("No active legal entity selected.")
