...
import eu.grandmedical.diten.mobile.feature.timeattendanceleave.data.mapper.toDomain
import eu.grandmedical.diten.mobile.feature.timeattendanceleave.data.mapper.toEntity
import eu.grandmedical.diten.mobile.feature.timeattendanceleave.data.mapper.toListItem
 ...
 */
class TimeAttendanceLeaveRepositoryImpl @Inject constructor(
    private val dao: TimeAttendanceLeaveDao,
    private val api: TimeAttendanceLeaveApi,
    private val safeApiCaller: SafeApiCaller,
    private val scopeProvider: TimeAttendanceLeaveScopeProvider,
    private val syncScheduler: SyncScheduler,
) : TimeAttendanceLeaveRepository {

    override fun observeList(): Flow<List<TimeAttendanceLeaveListItem>> = flow {
    ...
    override fun observe(id: String): Flow<TimeAttendanceLeaveReadiness?> =
    ...
    override suspend fun evaluate(id: String): UiResult<TimeAttendanceLeaveReadiness> {
        val scope = scopeProvider.currentScope()
            ?: return UiResult.Error("No active legal entity selected.")
