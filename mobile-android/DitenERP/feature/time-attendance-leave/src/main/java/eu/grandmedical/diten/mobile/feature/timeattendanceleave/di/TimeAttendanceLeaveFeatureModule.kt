...
/**
 * Contributes the Time & Leave Management feature to the app shell through the
...
object TimeAttendanceLeaveFeatureModule {

    /** Menu half: the permission-gated Home entry. */
    @Provides
    @IntoSet
    fun provideFeatureEntry(): FeatureEntry = TimeAttendanceLeaveFeature.entry
    ...
    fun provideFeatureNavGraph(): FeatureNavGraph =
        FeatureNavGraph { builder, navController ->
            TimeAttendanceLeaveFeature.register(builder, navController)
        }
}
