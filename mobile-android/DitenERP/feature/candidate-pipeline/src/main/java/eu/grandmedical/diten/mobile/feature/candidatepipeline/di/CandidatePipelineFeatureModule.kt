...
/**
 * Contributes the Candidate Pipeline feature to the app shell through the
...
object CandidatePipelineFeatureModule {

    /** Menu half: the permission-gated Home entry. */
    @Provides
    @IntoSet
    fun provideFeatureEntry(): FeatureEntry = CandidatePipelineFeature.entry
    ...
    fun provideFeatureNavGraph(): FeatureNavGraph =
        FeatureNavGraph { builder, navController ->
            CandidatePipelineFeature.register(builder, navController)
        }
}
