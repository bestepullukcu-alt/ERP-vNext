...
interface CandidatePipelineDao {
     ...
     */
    @Query("SELECT * FROM candidate_pipeline WHERE sync_status != :synced ORDER BY code ASC")
    suspend fun getUnsynced(synced: SyncStatus = SyncStatus.SYNCED): List<CandidatePipelineEntity>
