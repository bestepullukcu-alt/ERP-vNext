...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const companiesUrl = `${protocol}//${domain}:${port}/services/PvOrganization/OrganizationControlller/GetOrganizationsByTenantId`;
    ...
    const formTypeUrl = `${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/GetPharmaceuticalFormTypes`;
...
$(document).ready(function () {
    $('#ddlFormType').on('change', function () {
        ...
        if (selectedBrandId) {
            fetchFormsByFormTypeId(`${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/GetPharmaceuticalFormByFormTypeId`, 'ddlForm', null, false);
...
function initEditPackagingForm() {
    $(document).on('click', '.edit-record', async function () {
        ...
        const formTypeUrl = `${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/GetPharmaceuticalFormByFormTypeId`;
                        ...
                        buttons: [
                            {
                                ...
                                action: function (e, dt, node, config) {
                                    ...
                                    const ingredientUrl = `${protocol}//${domain}:${port}/services/PvTenant/TenantActiveIngredient/GetActiveIngredientsByTenantId`;
                                    const formTypeUrl = `${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/GetPharmaceuticalFormByFormTypeId/3`;
...
function handleSkuFormSubmit() {
    ...
    if (!id) {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvOrganization/GlobalSku/CreateGlobalSku`, {
            method: 'POST',
            headers: {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvOrganization/GlobalSku/UpdateGlobalSku`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function loadGlobalSkuInformation() {
    ...
    const response = await fetch(`${protocol}//${domain}:${port}/services/PvOrganization/GlobalSku/GetGlobalSkuById/${id}`); // API adresin 
