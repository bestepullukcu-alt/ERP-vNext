...
async function loadPermissions() {
    ...
    const response = await fetch(`${protocol}//${domain}:${port}/services/PvTenant/Menu/GetPageByTenantId`); // API adresin 
...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvTenant/Role/CreateRole`, {
            method: 'POST',
            headers: {
