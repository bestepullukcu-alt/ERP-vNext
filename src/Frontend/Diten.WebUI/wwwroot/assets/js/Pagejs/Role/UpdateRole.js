...
async function loadPermissions() {
    ...
    const response = await fetch(`${protocol}//${domain}:${port}/services/PvTenant/Role/GetPermissionByRoleId/${id}`); // API adresin 
...
function handleUpdateFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvTenant/Role/UpdateRole`, {
            method: 'POST',
            headers: {
