...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const regulatoryReportStatusUrl = `${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReport/GetRegulatoryReportStatus`;
    ...
    if (dt_regulatory_report_task_table) {
        ...
        if (savedRegulatoryReportId) {
            const dt_regulatory_report_task = new DataTable(dt_regulatory_report_task_table, {
                ajax: {
                    url: `${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReportTask/GetRegulatoryTasksByRegulatoryReportId/${savedRegulatoryReportId}`,
                    method: 'GET',
                    dataSrc: 'data',
...
function saveGeneral() {
    ...
    if (!id) {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReport/CreateRegulatoryReport`, {
            method: 'POST',
            headers: {
            ...
            .then(data => {
                ...
                if (isSuccess) {
                    ...
                    fetch(`${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReport/UpdateRegulatoryReportDocuments`, {
                        method: 'POST',
                        body: formUploadData
                    })
                        .then(response => response.json())
...
function AddTaskView() {
    ...
    comments.length = 0;
    const taskStatusUrl = `${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReportTask/GetRegulatoryTaskStatus`;
    fetchDropdowns(taskStatusUrl, "ddlTaskStatus");

    const taskPriorityUrl = `${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReportTask/GetRegulatoryTaskPriority`;
    fetchDropdowns(taskPriorityUrl, "ddlPriority");

    const taskParentTaskUrl = `${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReportTask/GetRegulatoryParentTasksByRegulatoryReportId/${savedRegulatoryReportId}`;
...
function saveTask() {
    ...
    fetch(`${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReportTask/CreateRegulatoryTask`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
        ...
        .then(data => {
            ...
            if (isSuccess) {
                ...
                fetch(`${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReportTask/UpdateRegulatoryTaskDocuments`, {
                    method: 'POST',
...
async function loadRegulatoryReport() {
    ...
    const response = await fetch(`${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReport/GetRegulatoryReportById/${id}`); // API adresin 
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        const userName = window.getUserName();
        try {
            const response = await fetch(`${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReportTask/DeleteRegulatoryTask`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
