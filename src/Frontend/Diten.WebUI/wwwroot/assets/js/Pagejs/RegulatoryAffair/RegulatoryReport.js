...
function initDataTable(placeholderText, lanData) {
    ...
    if (dt_regulatoryReport_table) {
        ...
        const dt_regulatoryreport = new DataTable(dt_regulatoryReport_table, {
            ajax: {
                url: `${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReport/GetRegulatoryReports`,
                method: 'GET',
                dataSrc: 'data',
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            const response = await fetch(`${protocol}//${domain}:${port}/services/PvOrganization/RegulatoryReport/DeleteRegulatoryReport`, {
                method: 'POST',
                headers: {
