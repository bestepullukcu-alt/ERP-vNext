...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvSurvey/Survey/CreateSurvey`, {
            method: 'POST',
            body: formData
        })
            .then(response => response.json())
...
$(document).on('click', '.activate-record',async function () {
    ...
    if (!isAnyQuestions) {
        ...
        try {
            const response = await fetch(`${protocol}//${domain}:${port}/services/PvSurvey/Survey/ActivateSurvey`, {
                method: 'POST',
                body: activateData
            });
...
document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
    ...
    try {
        const response = await fetch(`${protocol}//${domain}:${port}/services/PvSurvey/Survey/DeleteSurvey`, {
            method: 'POST',
            body: deletedData
        });
