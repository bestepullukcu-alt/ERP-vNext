...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const url = `${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/GetPharmaceuticalFormTypes`;
...
function initPharmaceuticalFormDataTable() {
    ...
    if (dt_pharmaceutical_form_table) {
        const dt_pharmaceutical_form = new DataTable(dt_pharmaceutical_form_table, {
            ajax: {
                url: `${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/GetPharmaceuticalFormByTenantId`,
                method: 'GET',
                dataSrc: 'data'
            },
            columns: [
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            ...
            const response = await fetch(`${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/DeleteTenantPharmaceuticalForm`, {
                method: 'POST',
                headers: {
...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/CreateTenantPharmaceuticalForm`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function handleUpdateFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvTenant/TenantPharmaceuticalForm/UpdateTenantPharmaceuticalForm`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
