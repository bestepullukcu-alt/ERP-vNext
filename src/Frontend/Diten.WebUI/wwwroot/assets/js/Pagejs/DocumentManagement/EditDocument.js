...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        const res = await fetch(`${protocol}//${domain}:${port}/services/PvDocumentManagement/Document/GetDocumentById?id=${documentId}`);
...
$("#uploadDocumentForm").on("submit", async function (e) {
    ...
    try {
        const res = await fetch(`${protocol}//${domain}:${port}/services/PvDocumentManagement/Document/UpdateDocument`, {
            method: "POST",
            body: formData
        });
