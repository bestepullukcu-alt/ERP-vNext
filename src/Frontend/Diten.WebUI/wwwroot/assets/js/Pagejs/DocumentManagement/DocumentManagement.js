...
async function handleInitialCreateFolder() {
    ...
    const response = await fetch(`${protocol}//${domain}:${port}/services/PvDocumentManagement/Folder/CreateFolder`, {
        method: 'POST',
...
async function getFolders() {
    const userId = window.getUserId();
    try {
        const response = await fetch(`${protocol}//${domain}:${port}/services/PvDocumentManagement/Folder/GetFolderByUserId?id=${userId}`);
