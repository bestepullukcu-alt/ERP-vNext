...
function initGlobalBrandDataTable() {
    ...
    if (dt_globalBrand_table) {
        const dt_globalBrand = new DataTable(dt_globalBrand_table, {
            ajax: {
                url: `${protocol}//${domain}:${port}/services/PvTenant/TenantBrand/GetBrandsByTenantId`,
                method: 'GET',
                dataSrc: 'data'
            },
            columns: [
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            const response = await fetch(`${protocol}//${domain}:${port}/services/PvTenant/TenantBrand/DeleteTenantBrand`, {
                method: 'POST',
                headers: {
...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvTenant/TenantBrand/CreateTenantBrand`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function initEditGlobalBrand() {
    $(document).on('click', '.edit-record', function () {
        ...
        const url = `${protocol}//${domain}:${port}/services/PvOrganization/OrganizationControlller/GetOrganizationsByTenantId`;
...
function handleUpdateFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvTenant/TenantBrand/UpdateTenantBrand`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function initActiveDisableGlobalBrand() {
    $(document).on('click', '.activate-disabled-record', function () {
        ...
        fetch(`${protocol}//${domain}:${port}/services/PvTenant/TenantBrand/activate-disable`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
