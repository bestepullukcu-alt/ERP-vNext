...
function initDataTable(placeholderText, lanData) {
    ...
    if (dt_safety_table) {
        const dt_safety = new DataTable(dt_safety_table, {
            ajax: {
                url: `${protocol}//${domain}:${port}/services/PvOrganization/SafetyReport/GetSafetyReports`,
                method: 'GET',
                dataSrc: 'data',
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            const response = await fetch(`${protocol}//${domain}:${port}/services/PvOrganization/SafetyReport/DeleteSafetyReport`, {
                method: 'POST',
                headers: {
