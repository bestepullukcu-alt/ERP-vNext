        ...
        },
          {
              ...
              render: function (data, type, full, meta) {
                  ...
                  if (statusId === 1 || statusId === 4) {
                      buttons += `<button class="btn btn-sm btn-icon btn-primary me-1 edit-record" title="Edit">
                    <i class="bx bx-edit-alt"></i>
                  </button>`;
                  } else if (statusId === 2 || statusId === 3) {
                      buttons += `<button class="btn btn-sm btn-icon btn-info me-1 view-record" title="View">
                  ...
                  if (statusId === 1) {
                      dropdownItems += `
        <a href="javascript:void(0);" class="dropdown-item send-to-approved">Send to Approved</a>
        <a href="javascript:void(0);" class="dropdown-item delete-record">Delete</a>`;
                  } else if (statusId === 2) {
                      dropdownItems += `
        <a href="javascript:void(0);" class="dropdown-item back-to-progress">In Progress</a>
        <a href="javascript:void(0);" class="dropdown-item approve-record">Approve</a>
        <a href="javascript:void(0);" class="dropdown-item reject-record">Reject</a>`;
                  } else if (statusId === 3) {
                      dropdownItems += `
        <a href="javascript:void(0);" class="dropdown-item back-to-progress">In Progress</a>`;
                  } else if (statusId === 4) {
                      dropdownItems += `
        <a href="javascript:void(0);" class="dropdown-item back-to-progress">In Progress</a>
        <a href="javascript:void(0);" class="dropdown-item send-to-approved">Approved</a>
        <a href="javascript:void(0);" class="dropdown-item delete-record">Delete</a>`;
                  }
