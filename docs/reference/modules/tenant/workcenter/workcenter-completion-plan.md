...
> **İlgili:** [`docs/roadmap/backlog/product-backlog.md`](./product-backlog.md) ·
> [`docs/reference/modules/tenant/workcenter/workcenter-test-sequence.md`](./workcenter-test-sequence.md) ·
...
[`docs/reference/modules/tenant/workcenter/workcenter-user-guide.md`](./workcenter-user-guide.md) — 11 bölüm başlığı + bağımlılık haritası,
...
[`docs/reference/modules/tenant/workcenter/workcenter-onboarding-sop.md`](./workcenter-onboarding-sop.md) (BL-073) — ana veri zinciri,
...
(bugün `docs/reference/modules/platform/` altında, ismi tarihsel; taşımak 21 dosyanın linkini kırar — **CT önerisi: kalsın**).
...
> [`docs/reference/modules/tenant/workcenter/workcenter-onboarding-sop.md`](./workcenter-onboarding-sop.md) — BL-073.
