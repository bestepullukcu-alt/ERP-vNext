...
> **Bu döküman `docs/reference/modules/platform/master-plan.md` companion'ıdır:**
...
ERP-vNext projesinin objektif durum analizi ve sıralı yapılacaklar zinciri. `docs/reference/modules/platform/master-plan.md` (2451 satır, 2026-05-17 son reconciliation) ve canlı kod karşılaştırması temel alınarak hazırlandı.
...
**Master kaynak:**
- `docs/reference/modules/platform/master-plan.md` — tek truth (modül başına `What's done` + `%100 için kalanlar`)
- `docs/reference/modules/platform/master-plan.md` §9.1/9.2/9.3 — wave bazlı status tablosu
