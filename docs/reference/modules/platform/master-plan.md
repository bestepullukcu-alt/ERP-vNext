...
**Hedef Kayıt Yeri:** `docs/reference/modules/platform/master-plan.md`
**Versiyon:** 1.0
**Tarih:** 2026-05-11
...
- Docs: `docs/reference/modules/platform/module-catalog/`
...
- `docs/reference/modules/platform/module-catalog/api.md`
- `docs/reference/modules/platform/module-catalog/user-manual.md`
