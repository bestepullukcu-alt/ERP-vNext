...
Use the production secret scan tooling and service builds described in `docs/records/audits/2026-05/pss-mod-0012-secrets-configuration-vault-audit-2026-05-12.md`.
