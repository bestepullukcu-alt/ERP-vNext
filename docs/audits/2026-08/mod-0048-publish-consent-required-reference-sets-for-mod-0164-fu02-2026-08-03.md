...
| Dosya | İşlem |
|---|---|
| `docs/audits/2026-08/mod-0048-publish-consent-required-reference-sets-for-mod-0164-fu02-2026-08-03.md` | **Oluşturuldu** (bu rapor) |
| `docs/audits/2026-08/mod-0048-publish-consent-required-reference-sets.operator.js` | **Oluşturuldu** (operator publish script; runtime kod değil) |
| `docs/audits/2026-08/mod-0048-crm-consent-campaign-knowledge-reference-set-authoring-template.json` | **Güncellendi** (`consent-legal-basis` ve `consent-source` → `_status: blocked-runtime-divergence` + F7/F8 kanıt notları; value dizileri değişmedi) |
