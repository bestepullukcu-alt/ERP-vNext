...
`docs/audits/2026-08/mod-0048-crm-consent-campaign-knowledge-reference-set-authoring-template.json` — operator-aid, publish/seed değil:
...
`docs/audits/2026-08/mod-0048-publish-consent-required-reference-sets.operator.js` — **değişiklik gerekmedi**:
...
| Dosya | İşlem |
|---|---|
| `docs/audits/2026-08/mod-0164-mod-0048-consent-vocabulary-source-of-truth-reconciliation-2026-08-03.md` | **Oluşturuldu** (bu rapor) |
| `docs/audits/2026-08/mod-0048-crm-consent-campaign-knowledge-reference-set-authoring-template.json` | **Güncellendi** (legal-basis + source runtime canonical'a hizalandı; `_status: resolved-runtime-sot`; `_meta.source_of_truth`) |
