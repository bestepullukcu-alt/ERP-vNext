...
| Dosya | İşlem |
|---|---|
| `docs/audits/2026-08/mod-0048-publish-consent-alignment-reference-sets-2026-08-03.md` | **Oluşturuldu** (bu rapor) |
| `docs/audits/2026-08/mod-0048-publish-consent-required-reference-sets.operator.js` | **Güncellendi** (envelope unwrap + snake_case gövde + read-back kodları) |
