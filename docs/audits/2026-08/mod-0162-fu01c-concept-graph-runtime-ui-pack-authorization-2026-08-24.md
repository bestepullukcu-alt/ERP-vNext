...
| MOD-0048 concept set publish | ❌ yayınlanmamış (yalnız authoring template'inde taslak) | `docs/audits/2026-08/mod-0048-crm-consent-campaign-knowledge-reference-set-authoring-template.json:371,387` |
...
| `docs/audits/2026-08/mod-0162-fu01c-concept-graph-runtime-ui-pack-authorization-2026-08-24.md` | Bu doküman |
