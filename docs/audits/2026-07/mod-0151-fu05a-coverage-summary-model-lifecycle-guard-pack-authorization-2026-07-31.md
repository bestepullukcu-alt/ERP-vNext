...
- **FU05 Account Assignment Apply + History Live Smoke Closeout PASS** doğrulandı:
  `docs/audits/2026-07/mod-0151-fu05-account-assignment-apply-history-live-smoke-closeout-2026-07-31.md` — **90 kontrol / 90 PASS / 0 FAIL**.
...
- **Created:** `docs/audits/2026-07/mod-0151-fu05a-coverage-summary-model-lifecycle-guard-pack-authorization-2026-07-31.md` (bu rapor)
