...
> Bağlam: ERP-vNext'te PV modülü **yoktur** (greenfield); bkz. `docs/records/analysis/pv-*`. Bu değerlendirme, PV'nin bu 9 platform modülünü **yeniden kullanabilirliğini** ölçer.
