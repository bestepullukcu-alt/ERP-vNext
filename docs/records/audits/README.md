...
This folder is the central audit archive for ERP-vNext. Audit reports stay here for all domains; domain documentation folders such as `docs/reference/modules/platform/` link back to these files instead of owning separate audit folders.
