...
- Value payloads (kebab `valueCode`, `isDeprecated:false`) + exact API sequence: see `docs/records/audits/2026-08/mod-0149-mod0048-required-reference-publish-closeout.md` and `mod-0149-crm-reference-data-authoring-template.json`.
