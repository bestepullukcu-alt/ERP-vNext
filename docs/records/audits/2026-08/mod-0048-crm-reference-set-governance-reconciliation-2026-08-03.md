...
`docs/records/audits/2026-08/mod-0048-crm-consent-campaign-knowledge-reference-set-authoring-template.json` **operator-aid olarak güncellendi** (publish/seed/runtime değil):
...
| Dosya | İşlem |
|---|---|
| `docs/records/audits/2026-08/mod-0048-crm-reference-set-governance-reconciliation-2026-08-03.md` | **Oluşturuldu** (bu rapor) |
| `docs/records/audits/2026-08/mod-0048-crm-consent-campaign-knowledge-reference-set-authoring-template.json` | **Güncellendi** (operator-aid `_status`/`_resolution` alanları + `_meta.reconciliation_2026_08_03`; value içeriği değişmedi) |
