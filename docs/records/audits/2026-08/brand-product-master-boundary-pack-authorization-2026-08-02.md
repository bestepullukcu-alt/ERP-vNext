...
| Çalışma alanı | `execution/domains/master-data-management/**`, `execution/domains/commercial-suite/module-packs/**`, `docs/records/audits/**` |
...
| `docs/records/audits/2026-08/brand-product-master-boundary-pack-authorization-2026-08-02.md` | **Oluşturuldu** (bu rapor) |
