...
- Referans desen: **MOD-0150 Contact Import/Export** (template → export → upload → **dry-run** → safe apply),
  `docs/records/audits/2026-08/mod-0150-contact-import-export-task2-xlsx-upload-dryrun-apply.md`. FU08 bu deseni MOD-0151 nesnelerine
...
- **Created:** `docs/records/audits/2026-08/mod-0151-fu08-import-export-hardening-pack-authorization-2026-08-01.md` (bu rapor)
