...
```
Payloads: `docs/records/audits/2026-08/mod-0149-crm-reference-data-authoring-template.json`. Full recipe: `mod-0149-mod0048-required-reference-publish-closeout.md`.
