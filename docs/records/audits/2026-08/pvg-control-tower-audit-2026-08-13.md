...
> Operating Card from `/Users/natig/Downloads/` and the repository copies under `docs/guides/control-tower/`.
...
- `docs/guides/control-tower/control-tower-sop.md`
- `docs/guides/control-tower/control-tower-operating-card.md`
- `AGENTS.md`
...
- `docs/roadmap/plans/pvg-fast-track-execution-plan-2026-08-09.md`
