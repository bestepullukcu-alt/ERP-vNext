...
| Blok | Durum | Kanıt |
|---|---|---|
| CRM service scaffold + gateway + RBAC + reference data + 7 dil | **PASS** | `docs/records/audits/2026-07/diten-crm-service-scaffold-implementation-2026-07-14.md` |
...
2. **FU05'in bugünkü gerçek durumu belgeye dayanmıyor.** 2026-07-31'de apply'ın çalıştığı bilgisi oturum hafızasından geliyor; `docs/records/audits/` altında karşılığı yok. En güncel FU05 canlı raporu hâlâ **FAIL**.
...
| Dosya | Aksiyon |
|---|---|
| `docs/records/audits/2026-07/crm-capability-progress-review-2026-07-31.md` | Created |
