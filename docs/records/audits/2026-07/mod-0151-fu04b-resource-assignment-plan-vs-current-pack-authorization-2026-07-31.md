...
| FU04A pack authorization | **PASS** — `docs/records/audits/2026-07/mod-0151-fu04a-pack-runtime-scope-authorization-2026-07-30.md` |
| FU04A implementation | **PARTIAL** — `docs/records/audits/2026-07/mod-0151-fu04a-resource-assignment-lifecycle-replacement-operational-visibility-implementation-2026-07-30.md`; ana davranışlar mevcut (position-based lifecycle, proposed→active transition, active create/end, replacement, transfer, current responsibility, history query) |
...
| `docs/records/audits/2026-07/mod-0151-fu04b-resource-assignment-plan-vs-current-pack-authorization-2026-07-31.md` | **Created** | Bu rapor |
