...
| Audit raporları | 7 | `docs/records/audits/mod-0029-fu2*.md`, `...fu3*.md` |
...
| Grup | Dosyalar |
|---|---|
| CRM / MOD-0149 / MOD-0150 | `services/Diten.CrmService/` (yeni), `Features/Crm/`, `frontend/Diten.Web/{Controllers,Models,Views,Resources/Views,wwwroot/assets/js}/CRM/`, `execution/domains/commercial-suite/`, 30+ `docs/records/audits/mod-0149*/mod-0150*` |
...
| 7 | MOD-0029 audit dokümanları | `docs/records/audits/mod-0029-fu23*.md`, `fu29*.md`, `fu29a*.md`, `fu30*.md`, `fu31*.md`, `fu31a*.md`, `fu32*.md`, `fu33*.md` (bu rapor), `gmg-qms-sop-0001-*.md` | Yok | — |
...
| Dosya | Tip |
|---|---|
| `docs/records/audits/2026-07/mod-0029-fu33-final-governance-smoke-regression-2026-07-23.md` | **Yeni** — bu rapor |
