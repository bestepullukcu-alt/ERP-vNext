...
| File | Action | Notes |
|---|---|---|
| `docs/records/audits/2026-07/mod-0151-territory-management-current-state-and-roadmap-2026-07-25.md` | Created | Mevcut durum, business açıklama, sınırlar ve roadmap |
