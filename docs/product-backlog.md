...
- **Yapım tetikleyicisi:** **Blueprint'e (`docs/blueprint/System Capability & Implementation Blueprint - master 7.xlsx`) bakılarak, org-model buna uygunsa yapılacak** — aksi halde mevcut tiplerle temsil devam.
