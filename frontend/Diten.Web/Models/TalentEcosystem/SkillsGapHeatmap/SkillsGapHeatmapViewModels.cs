...
namespace Diten.Web.Models.TalentEcosystem.SkillsGapHeatmap;

// Enum field values map 1:1 to the backend SkillsGapHeatmapReadinessState ordinals:
...
public sealed class SkillsGapHeatmapEditViewModel
{
    ...
    // Readiness & workflow
    public int SkillsGapHeatmapReadinessState { get; set; } = 0;                     // Draft
    public int GapCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int HeatmapBindingIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int SeverityScopeBoundaryState { get; set; } = 3;              // Blocked
    public int VisibilityControlBoundaryState { get; set; } = 3;            // Blocked
    public int GapReviewBoundaryState { get; set; } = 3;                   // Blocked
    ...
    public int TalentDemandForecastSourceDependencyState { get; set; } = 2;                    // Deferred
...
public sealed class SkillsGapHeatmapDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int SkillsGapHeatmapReadinessState { get; set; }
    public int GapCatalogBoundaryState { get; set; }
    public int HeatmapBindingIntakeBoundaryState { get; set; }
    public int SeverityScopeBoundaryState { get; set; }
    public int VisibilityControlBoundaryState { get; set; }
    public int GapReviewBoundaryState { get; set; }
    ...
    public int TalentDemandForecastSourceDependencyState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long SkillsGapHeatmapReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring SkillsGapHeatmapReadinessState.
...
// Sent to the gateway create endpoint. Property names match SkillsGapHeatmapReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class SkillsGapHeatmapSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int SkillsGapHeatmapReadinessState { get; set; }
