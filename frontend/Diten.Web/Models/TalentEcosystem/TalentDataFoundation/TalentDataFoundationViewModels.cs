...
namespace Diten.Web.Models.TalentEcosystem.TalentDataFoundation;

// Enum field values map 1:1 to the backend TalentDataFoundationReadinessState ordinals:
...
public sealed class TalentDataFoundationEditViewModel
{
    ...
    // Readiness & workflow
    public int TalentDataFoundationReadinessState { get; set; } = 0;                     // Draft
    public int TalentEntityCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int DataIngestionBoundaryState { get; set; } = 3;     // Blocked
    public int IdentityResolutionBoundaryState { get; set; } = 3;              // Blocked
    public int DataQualityBoundaryState { get; set; } = 3;            // Blocked
    public int LineageTrackingBoundaryState { get; set; } = 3;                   // Blocked
    public int AutomatedDecisionBoundaryState { get; set; } = 3;              // Blocked

    // Dependencies
    public int HcmFoundationDependencyState { get; set; } = 2;               // Deferred
...
public sealed class TalentDataFoundationDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int TalentDataFoundationReadinessState { get; set; }
    public int TalentEntityCatalogBoundaryState { get; set; }
    public int DataIngestionBoundaryState { get; set; }
    public int IdentityResolutionBoundaryState { get; set; }
    public int DataQualityBoundaryState { get; set; }
    public int LineageTrackingBoundaryState { get; set; }
    public int AutomatedDecisionBoundaryState { get; set; }
    public int HcmFoundationDependencyState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long TalentDataFoundationReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring TalentDataFoundationReadinessState.
...
// Sent to the gateway create endpoint. Property names match TalentDataFoundationReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class TalentDataFoundationSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int TalentDataFoundationReadinessState { get; set; }
