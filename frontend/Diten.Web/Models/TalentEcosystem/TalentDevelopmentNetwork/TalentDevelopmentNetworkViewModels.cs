...
namespace Diten.Web.Models.TalentEcosystem.TalentDevelopmentNetwork;

// Enum field values map 1:1 to the backend TalentDevelopmentNetworkReadinessState ordinals:
...
public sealed class TalentDevelopmentNetworkEditViewModel
{
    ...
    // Readiness & workflow
    public int TalentDevelopmentNetworkReadinessState { get; set; } = 0;                     // Draft
    public int PathwayCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int MentorshipLinkIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int ProgressionScopeBoundaryState { get; set; } = 3;              // Blocked
    ...
    public int ProgressionPolicyState { get; set; } = 2;      // Deferred

    public string? DeferredReason { get; set; }
}

public sealed class TalentDevelopmentNetworkDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int TalentDevelopmentNetworkReadinessState { get; set; }
    public int PathwayCatalogBoundaryState { get; set; }
    public int MentorshipLinkIntakeBoundaryState { get; set; }
    public int ProgressionScopeBoundaryState { get; set; }
    ...
    public int ProgressionPolicyState { get; set; }
    public string SourceContractVersion { get; set; } = string.Empty;
    public long TalentDevelopmentNetworkReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring TalentDevelopmentNetworkReadinessState.
...
// Sent to the gateway create endpoint. Property names match TalentDevelopmentNetworkReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class TalentDevelopmentNetworkSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int TalentDevelopmentNetworkReadinessState { get; set; }
