...
namespace Diten.Web.Models.TalentEcosystem.IndustrySuccessionPool;

// Enum field values map 1:1 to the backend IndustrySuccessionPoolReadinessState ordinals:
...
public sealed class IndustrySuccessionPoolEditViewModel
{
    ...
    // Readiness & workflow
    public int IndustrySuccessionPoolReadinessState { get; set; } = 0;                     // Draft
    public int PoolCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int CandidateInclusionIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int ReadinessTierScopeBoundaryState { get; set; } = 3;              // Blocked
    public int VisibilityControlBoundaryState { get; set; } = 3;            // Blocked
    public int SuccessionReviewBoundaryState { get; set; } = 3;                   // Blocked
    ...
    public int TalentPoolSourceDependencyState { get; set; } = 2;                    // Deferred
...
public sealed class IndustrySuccessionPoolDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int IndustrySuccessionPoolReadinessState { get; set; }
    public int PoolCatalogBoundaryState { get; set; }
    public int CandidateInclusionIntakeBoundaryState { get; set; }
    public int ReadinessTierScopeBoundaryState { get; set; }
    public int VisibilityControlBoundaryState { get; set; }
    public int SuccessionReviewBoundaryState { get; set; }
    ...
    public int TalentPoolSourceDependencyState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long IndustrySuccessionPoolReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring IndustrySuccessionPoolReadinessState.
...
// Sent to the gateway create endpoint. Property names match IndustrySuccessionPoolReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class IndustrySuccessionPoolSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int IndustrySuccessionPoolReadinessState { get; set; }
