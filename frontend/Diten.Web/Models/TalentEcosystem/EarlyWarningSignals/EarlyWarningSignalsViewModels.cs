...
namespace Diten.Web.Models.TalentEcosystem.EarlyWarningSignals;

// Enum field values map 1:1 to the backend EarlyWarningSignalsReadinessState ordinals:
...
public sealed class EarlyWarningSignalsEditViewModel
{
    ...
    // Readiness & workflow
    public int EarlyWarningSignalsReadinessState { get; set; } = 0;                     // Draft
    public int SignalCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int PatternDetectionBoundaryState { get; set; } = 3;     // Blocked
    public int CrossCompanyCorrelationBoundaryState { get; set; } = 3;              // Blocked
    public int AlertRoutingBoundaryState { get; set; } = 3;            // Blocked
    public int SignalReviewBoundaryState { get; set; } = 3;                   // Blocked
    public int AutomatedDecisionBoundaryState { get; set; } = 3;              // Blocked

    // Dependencies
    public int TalentDataSourceDependencyState { get; set; } = 2;               // Deferred
    public int RiskIndicatorSourceDependencyState { get; set; } = 2;           // Deferred
...
public sealed class EarlyWarningSignalsDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int EarlyWarningSignalsReadinessState { get; set; }
    public int SignalCatalogBoundaryState { get; set; }
    public int PatternDetectionBoundaryState { get; set; }
    public int CrossCompanyCorrelationBoundaryState { get; set; }
    public int AlertRoutingBoundaryState { get; set; }
    public int SignalReviewBoundaryState { get; set; }
    public int AutomatedDecisionBoundaryState { get; set; }
    public int TalentDataSourceDependencyState { get; set; }
    public int RiskIndicatorSourceDependencyState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long EarlyWarningSignalsReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring EarlyWarningSignalsReadinessState.
...
// Sent to the gateway create endpoint. Property names match EarlyWarningSignalsReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class EarlyWarningSignalsSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int EarlyWarningSignalsReadinessState { get; set; }
