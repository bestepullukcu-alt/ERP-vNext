...
namespace Diten.Web.Models.TalentEcosystem.ProfessionalReputationLedger;

// Enum field values map 1:1 to the backend ProfessionalReputationLedgerReadinessState ordinals:
...
public sealed class ProfessionalReputationLedgerEditViewModel
{
    ...
    // Readiness & workflow
    public int ProfessionalReputationLedgerReadinessState { get; set; } = 0;                     // Draft
    public int ReputationSignalCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int EndorsementIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int AttributionScopeBoundaryState { get; set; } = 3;              // Blocked
...
public sealed class ProfessionalReputationLedgerDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int ProfessionalReputationLedgerReadinessState { get; set; }
    public int ReputationSignalCatalogBoundaryState { get; set; }
    public int EndorsementIntakeBoundaryState { get; set; }
    public int AttributionScopeBoundaryState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long ProfessionalReputationLedgerReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring ProfessionalReputationLedgerReadinessState.
...
// Sent to the gateway create endpoint. Property names match ProfessionalReputationLedgerReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class ProfessionalReputationLedgerSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int ProfessionalReputationLedgerReadinessState { get; set; }
