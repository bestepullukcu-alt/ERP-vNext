...
namespace Diten.Web.Models.TalentEcosystem.TalentSupplyDemandForecasting;

// Enum field values map 1:1 to the backend TalentSupplyDemandForecastingReadinessState ordinals:
...
public sealed class TalentSupplyDemandForecastingEditViewModel
{
    ...
    // Readiness & workflow
    public int TalentSupplyDemandForecastingReadinessState { get; set; } = 0;                     // Draft
    public int ForecastCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int ModelBindingIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int HorizonScopeBoundaryState { get; set; } = 3;              // Blocked
    public int VisibilityControlBoundaryState { get; set; } = 3;            // Blocked
    public int ForecastReviewBoundaryState { get; set; } = 3;                   // Blocked
...
public sealed class TalentSupplyDemandForecastingDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int TalentSupplyDemandForecastingReadinessState { get; set; }
    public int ForecastCatalogBoundaryState { get; set; }
    public int ModelBindingIntakeBoundaryState { get; set; }
    public int HorizonScopeBoundaryState { get; set; }
    public int VisibilityControlBoundaryState { get; set; }
    public int ForecastReviewBoundaryState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long TalentSupplyDemandForecastingReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring TalentSupplyDemandForecastingReadinessState.
...
// Sent to the gateway create endpoint. Property names match TalentSupplyDemandForecastingReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class TalentSupplyDemandForecastingSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int TalentSupplyDemandForecastingReadinessState { get; set; }
