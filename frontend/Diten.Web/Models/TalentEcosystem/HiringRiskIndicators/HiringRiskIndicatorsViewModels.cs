...
namespace Diten.Web.Models.TalentEcosystem.HiringRiskIndicators;

// Enum field values map 1:1 to the backend HiringRiskIndicatorsReadinessState ordinals:
...
public sealed class HiringRiskIndicatorsEditViewModel
{
    ...
    // Readiness & workflow
    public int HiringRiskIndicatorsReadinessState { get; set; } = 0;                     // Draft
    public int RiskIndicatorCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int RiskSignalIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int RiskAssessmentBoundaryState { get; set; } = 3;              // Blocked
    public int MitigationTrackingBoundaryState { get; set; } = 3;            // Blocked
    public int IndicatorReviewBoundaryState { get; set; } = 3;                   // Blocked
...
public sealed class HiringRiskIndicatorsDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int HiringRiskIndicatorsReadinessState { get; set; }
    public int RiskIndicatorCatalogBoundaryState { get; set; }
    public int RiskSignalIntakeBoundaryState { get; set; }
    public int RiskAssessmentBoundaryState { get; set; }
    public int MitigationTrackingBoundaryState { get; set; }
    public int IndicatorReviewBoundaryState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long HiringRiskIndicatorsReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring HiringRiskIndicatorsReadinessState.
...
// Sent to the gateway create endpoint. Property names match HiringRiskIndicatorsReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class HiringRiskIndicatorsSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int HiringRiskIndicatorsReadinessState { get; set; }
