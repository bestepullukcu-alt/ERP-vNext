...
namespace Diten.Web.Models.TalentEcosystem.CandidateCareerPassport;

// Enum field values map 1:1 to the backend CandidateCareerPassportReadinessState ordinals:
...
public sealed class CandidateCareerPassportEditViewModel
{
    ...
    // Readiness & workflow
    public int CandidateCareerPassportReadinessState { get; set; } = 0;                     // Draft
    public int CareerMilestoneCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int ExperienceIntakeBoundaryState { get; set; } = 3;     // Blocked
    ...
    public int PortabilityPolicyState { get; set; } = 2;      // Deferred

    public string? DeferredReason { get; set; }
}

public sealed class CandidateCareerPassportDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int CandidateCareerPassportReadinessState { get; set; }
    public int CareerMilestoneCatalogBoundaryState { get; set; }
    public int ExperienceIntakeBoundaryState { get; set; }
    ...
    public int PortabilityPolicyState { get; set; }
    public string SourceContractVersion { get; set; } = string.Empty;
    public long CandidateCareerPassportReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring CandidateCareerPassportReadinessState.
...
// Sent to the gateway create endpoint. Property names match CandidateCareerPassportReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class CandidateCareerPassportSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int CandidateCareerPassportReadinessState { get; set; }
