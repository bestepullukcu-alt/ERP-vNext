...
namespace Diten.Web.Models.TalentEcosystem.IndustryTalentPool;

// Enum field values map 1:1 to the backend IndustryTalentPoolReadinessState ordinals:
...
public sealed class IndustryTalentPoolEditViewModel
{
    ...
    // Readiness & workflow
    public int IndustryTalentPoolReadinessState { get; set; } = 0;                     // Draft
    public int PoolMembershipCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int CandidateInclusionIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int EligibilityScopeBoundaryState { get; set; } = 3;              // Blocked
    public int VisibilityControlBoundaryState { get; set; } = 3;            // Blocked
    public int PoolCurationReviewBoundaryState { get; set; } = 3;                   // Blocked
    ...
    public int ReputationSourceDependencyState { get; set; } = 2;                    // Deferred
    ...
    public int EligibilityPolicyState { get; set; } = 2;      // Deferred

    public string? DeferredReason { get; set; }
}

public sealed class IndustryTalentPoolDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int IndustryTalentPoolReadinessState { get; set; }
    public int PoolMembershipCatalogBoundaryState { get; set; }
    public int CandidateInclusionIntakeBoundaryState { get; set; }
    public int EligibilityScopeBoundaryState { get; set; }
    public int VisibilityControlBoundaryState { get; set; }
    public int PoolCurationReviewBoundaryState { get; set; }
    ...
    public int ReputationSourceDependencyState { get; set; }
    ...
    public int EligibilityPolicyState { get; set; }
    public string SourceContractVersion { get; set; } = string.Empty;
    public long IndustryTalentPoolReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring IndustryTalentPoolReadinessState.
...
// Sent to the gateway create endpoint. Property names match IndustryTalentPoolReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class IndustryTalentPoolSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int IndustryTalentPoolReadinessState { get; set; }
