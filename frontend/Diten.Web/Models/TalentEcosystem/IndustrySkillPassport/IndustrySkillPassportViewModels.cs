...
namespace Diten.Web.Models.TalentEcosystem.IndustrySkillPassport;

// Enum field values map 1:1 to the backend IndustrySkillPassportReadinessState ordinals:
...
public sealed class IndustrySkillPassportEditViewModel
{
    ...
    // Readiness & workflow
    public int IndustrySkillPassportReadinessState { get; set; } = 0;                     // Draft
    public int SkillClaimCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int AttestationIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int VerificationScopeBoundaryState { get; set; } = 3;              // Blocked
    public int VisibilityControlBoundaryState { get; set; } = 3;            // Blocked
    public int PassportReviewBoundaryState { get; set; } = 3;                   // Blocked
    ...
    public int CertificationSourceDependencyState { get; set; } = 2;                    // Deferred
    ...
    public int VerificationPolicyState { get; set; } = 2;      // Deferred

    public string? DeferredReason { get; set; }
}

public sealed class IndustrySkillPassportDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int IndustrySkillPassportReadinessState { get; set; }
    public int SkillClaimCatalogBoundaryState { get; set; }
    public int AttestationIntakeBoundaryState { get; set; }
    public int VerificationScopeBoundaryState { get; set; }
    public int VisibilityControlBoundaryState { get; set; }
    public int PassportReviewBoundaryState { get; set; }
    ...
    public int CertificationSourceDependencyState { get; set; }
    ...
    public int VerificationPolicyState { get; set; }
    public string SourceContractVersion { get; set; } = string.Empty;
    public long IndustrySkillPassportReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring IndustrySkillPassportReadinessState.
...
// Sent to the gateway create endpoint. Property names match IndustrySkillPassportReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class IndustrySkillPassportSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int IndustrySkillPassportReadinessState { get; set; }
