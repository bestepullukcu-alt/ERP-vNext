...
namespace Diten.Web.Models.TalentEcosystem.MentorshipRecommendationNetwork;

// Enum field values map 1:1 to the backend MentorshipRecommendationNetworkReadinessState ordinals:
...
public sealed class MentorshipRecommendationNetworkEditViewModel
{
    ...
    // Readiness & workflow
    public int MentorshipRecommendationNetworkReadinessState { get; set; } = 0;                     // Draft
    public int NetworkCatalogBoundaryState { get; set; } = 3;                  // Blocked
    public int PairingIntakeBoundaryState { get; set; } = 3;     // Blocked
    public int RecommendationScopeBoundaryState { get; set; } = 3;              // Blocked
    public int VisibilityControlBoundaryState { get; set; } = 3;            // Blocked
    public int NetworkReviewBoundaryState { get; set; } = 3;                   // Blocked
...
public sealed class MentorshipRecommendationNetworkDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int MentorshipRecommendationNetworkReadinessState { get; set; }
    public int NetworkCatalogBoundaryState { get; set; }
    public int PairingIntakeBoundaryState { get; set; }
    public int RecommendationScopeBoundaryState { get; set; }
    public int VisibilityControlBoundaryState { get; set; }
    public int NetworkReviewBoundaryState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long MentorshipRecommendationNetworkReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring MentorshipRecommendationNetworkReadinessState.
...
// Sent to the gateway create endpoint. Property names match MentorshipRecommendationNetworkReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class MentorshipRecommendationNetworkSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int MentorshipRecommendationNetworkReadinessState { get; set; }
