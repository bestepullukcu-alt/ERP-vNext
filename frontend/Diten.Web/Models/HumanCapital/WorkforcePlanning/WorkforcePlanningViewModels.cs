...
namespace Diten.Web.Models.HumanCapital.WorkforcePlanning;

// Enum field values map 1:1 to the backend WorkforcePlanningReadinessState ordinals:
...
public sealed class WorkforcePlanningEditViewModel
{
    ...
    // Readiness & workflow
    public int WorkforcePlanningReadinessState { get; set; } = 0;                     // Draft
    public int HeadcountPlanBoundaryState { get; set; } = 3;                  // Blocked
    public int DemandForecastBoundaryState { get; set; } = 3;     // Blocked
    public int SupplyForecastBoundaryState { get; set; } = 3;              // Blocked
    public int GapAnalysisBoundaryState { get; set; } = 3;            // Blocked
    public int ScenarioModelingBoundaryState { get; set; } = 3;                   // Blocked
...
public sealed class WorkforcePlanningDetailViewModel
{
    public Guid Id { get; set; }
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int WorkforcePlanningReadinessState { get; set; }
    public int HeadcountPlanBoundaryState { get; set; }
    public int DemandForecastBoundaryState { get; set; }
    public int SupplyForecastBoundaryState { get; set; }
    public int GapAnalysisBoundaryState { get; set; }
    public int ScenarioModelingBoundaryState { get; set; }
    ...
    public string SourceContractVersion { get; set; } = string.Empty;
    public long WorkforcePlanningReadinessVersion { get; set; }
    public DateTimeOffset? LastEvaluatedAt { get; set; }
    public string? DeferredReason { get; set; }

    // Ordinal → canonical state name, mirroring WorkforcePlanningReadinessState.
...
// Sent to the gateway create endpoint. Property names match WorkforcePlanningReadinessCreateRequest.
// This module has NO manager/employee assessment UX fields; every scalar request field is included.
public sealed class WorkforcePlanningSavePayload
{
    public string Code { get; set; } = string.Empty;
    public string DisplayName { get; set; } = string.Empty;
    public int WorkforcePlanningReadinessState { get; set; }
