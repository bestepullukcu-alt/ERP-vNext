...
(function () {
    ...
    const source = doc.getElementById('baseline-experiment-measurement-l10n');
    const requiredKeys = [
    ...
    try {
        ...
        console.error('[BaselineExperimentMeasurement] Localization content could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
