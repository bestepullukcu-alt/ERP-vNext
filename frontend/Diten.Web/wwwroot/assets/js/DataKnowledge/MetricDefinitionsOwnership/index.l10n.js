...
(function () {
    ...
    const source = doc.getElementById('metric-definitions-ownership-l10n');
    const requiredKeys = [
    ...
    try {
        ...
        console.error('[MetricDefinitionsOwnership] Localization content could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
