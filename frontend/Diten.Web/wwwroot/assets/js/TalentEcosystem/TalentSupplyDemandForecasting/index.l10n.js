...
(function () {
    ...
    const source = doc.getElementById('talent-supply-demand-forecasting-l10n');
    const requiredKeys = [
    ...
    try {
        ...
        console.error('[TalentSupplyDemandForecasting] Localization content could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
