...
(function () {
    ...
    const source = doc.getElementById('verified-certification-registry-l10n');
    const requiredKeys = [
    ...
    try {
        ...
        console.error('[VerifiedCertificationRegistry] Localization content could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
