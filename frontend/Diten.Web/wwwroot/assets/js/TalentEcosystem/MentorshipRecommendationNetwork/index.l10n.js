...
(function () {
    ...
    const source = doc.getElementById('mentorship-recommendation-network-l10n');
    const requiredKeys = [
    ...
    try {
        ...
        console.error('[MentorshipRecommendationNetwork] Localization content could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
