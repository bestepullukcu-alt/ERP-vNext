...
(function () {
    ...
    const source = doc.getElementById('sector-mobility-intelligence-l10n');
    const requiredKeys = [
    ...
    try {
        ...
        console.error('[SectorMobilityIntelligence] Localization content could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
