...
(function () {
    ...
    const source = doc.getElementById('professional-reputation-ledger-l10n');
    const requiredKeys = [
    ...
    try {
        ...
        console.error('[ProfessionalReputationLedger] Localization content could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
