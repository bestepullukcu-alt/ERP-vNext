...
(function () {
    ...
    const source = doc.getElementById('restricted-integrity-registry-l10n');
    const requiredKeys = [
    ...
    try {
        ...
        console.error('[RestrictedIntegrityRegistry] Localization content could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
