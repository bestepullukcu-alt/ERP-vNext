...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const parentCompanyUrl = `${window.ApiBaseUrl}/services/PvOrganization/OrganizationControlller/GetParentCompanies`;

    fetchCountries(countryUrl, "add-company-country");
    fetchCountries(countryUrl, "update-company-country");
    //loadSelectPickerOptions(`${window.ApiBaseUrl}/services/PvTenant/Tenant/GetCountriesByTenantId`, "ddlOperatingCountries", "id", "name");
    //loadSelectPickerOptions(`${window.ApiBaseUrl}/services/PvTenant/Tenant/GetCountriesByTenantId`, "updateddlOperatingCountries", "id", "name");
...
function initCompanyDataTable(placeholderText, lanData) {
    ...
    if (dt_company_table) {
        const dt_company = new DataTable(dt_company_table, {
            ajax: {
                url: `${window.ApiBaseUrl}/services/PvOrganization/OrganizationControlller/GetOrganizationsByTenantId`,
                method: 'GET',
                dataSrc: 'data',
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            const response = await fetch(`${window.ApiBaseUrl}/services/PvOrganization/OrganizationControlller/DeleteOrganization`, {
                method: 'POST',
                headers: {
...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvOrganization/OrganizationControlller/CreateOrganization`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function handleUpdateFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvOrganization/OrganizationControlller/UpdateOrganization`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
