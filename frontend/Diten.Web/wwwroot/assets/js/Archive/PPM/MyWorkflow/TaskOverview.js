...
async function loadTaskOverview(filterModel) {
    try {
        const url = `${window.ApiBaseUrl}/services/DitenPPM/Task/GetTaskOverview`;
...
async function submitCreateTask(payload) {
    ...
    try {
        const url = `${window.ApiBaseUrl}/services/DitenPPM/Task/CreateShortTask`;
...
async function loadSubTaskCategories() {
    const res = await fetch(`${window.ApiBaseUrl}/services/DitenPPM/Task/GetTaskCategory`);
    const list = await res.json();
...
async function loadSubTaskStatus() {
    const res = await fetch(`${window.ApiBaseUrl}/services/DitenPPM/WorkflowCategory/GetWorkflowStatus`);
    const list = await res.json();
...
async function loadSubTaskPriorities() {
    const res = await fetch(`${window.ApiBaseUrl}/services/DitenPPM/WorkflowCategory/GetPriorities`);
    const list = await res.json();
...
async function createTask() {
    ...
    try {
        const url = `${window.ApiBaseUrl}/services/DitenPPM/Task/CreateFullTask`;
...
async function updateTask() {
    ...
    try {
        const url = `${window.ApiBaseUrl}/services/DitenPPM/Task/UpdateFullTask`;
...
async function deleteTaskById(taskId) {
    ...
    const url = `${window.ApiBaseUrl}/services/DitenPPM/Task/DeleteTask`;
