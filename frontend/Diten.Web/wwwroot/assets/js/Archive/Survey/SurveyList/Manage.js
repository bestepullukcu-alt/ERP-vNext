    ...
    fileInput.addEventListener("change", async (e) => {
        ...
        for (const file of files) {
            ...
            try {
                ...
                const response = await fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveyDesign/UploadImage`, {
                    method: "POST",
                    body: formData
                });
...
async function loadSurvey(templateIdOrId) {
    try {
        const response = await fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveyDesign/GetSurveyDesignBySurveyId?id=${templateIdOrId}`);
...
async function saveSurvey() {
    ...
    try {
        ...
        const response = await fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveyDesign/CreateSurveyDesign`, {
            method: "POST",
