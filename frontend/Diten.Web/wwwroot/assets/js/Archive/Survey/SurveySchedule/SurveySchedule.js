...
document.addEventListener('DOMContentLoaded', function () {
    ...
    populateSelect('ddl-survey', {
        apiUrl: `${window.ApiBaseUrl}/services/PvSurvey/Survey/GetSurveys`,
...
function handleScheduleSubmit(fv) {
    fv.on('core.form.valid', function () {
       ...
       const targetResponse = document.getElementById('add-target-response').value;
        ...
        fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveySchedule/CreateSchedule`, {
            method: 'POST',
            headers: {
...
function handleUpdateScheduleSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveySchedule/UpdateSchedule`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function loadSchedules() {
    try {
        const response = await fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveySchedule/GetSchedules`);
...
async function pauseTemplate(scheduleId) {
    ...
    fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveySchedule/UpdateScheduleStatus`, {
        method: 'POST',
...
async function settingsTemplate(scheduleId) {
    ...
    try {
        const response = await fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveySchedule/GetSettingsByScheduleId?id=${scheduleId}`);
...
document.getElementById('saveSettingsBtn').addEventListener('click', () => {
    ...
    fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveySchedule/CreateSettingsByScheduleId`, {
         method: 'POST',
         headers: { 'Content-Type': 'application/json' },
         body: JSON.stringify(command)
     }).then(res => res.json()).then(data => {
