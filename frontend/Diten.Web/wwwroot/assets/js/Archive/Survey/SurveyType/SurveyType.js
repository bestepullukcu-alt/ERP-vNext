...
function initDataTable(placeholderText, lanData) {
    ...
    if (dt_survey_type_table) {
        const dt_survey_type = new DataTable(dt_survey_type_table, {
            ...
            ajax: {
                url: `${window.ApiBaseUrl}/services/PvSurvey/SurveyType/GetSurveyTypes`,
                method: 'GET',
                dataSrc: 'data',
...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveyType/CreateSurveyType`, {
            method: 'POST',
            body: formData
        })
            .then(response => response.json())
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            const response = await fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveyType/DeleteSurveyType`, {
                method: 'POST',
                body: deletedData
            });
...
function handleUpdateFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvSurvey/SurveyType/UpdateSurveyType`, {
            method: 'POST',
            body: updatedData
        })
            .then(response => response.json())
