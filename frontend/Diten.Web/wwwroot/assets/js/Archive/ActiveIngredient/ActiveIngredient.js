...
function initActiveIngredientDataTable() {
    ...
    if (dt_activeIngredient_table) {
        const dt_activeIngredient = new DataTable(dt_activeIngredient_table, {
            ajax: {
                url: `${window.ApiBaseUrl}/services/PvTenant/TenantActiveIngredient/GetActiveIngredientsByTenantId`,
                method: 'GET',
                dataSrc: 'data'
            },
            columns: [
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            const response = await fetch(`${window.ApiBaseUrl}/services/PvTenant/TenantActiveIngredient/DeleteTenantActiveIngredient`, {
                method: 'POST',
                headers: {
...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvTenant/TenantActiveIngredient/CreateTenantActiveIngredient`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function handleUpdateFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvTenant/TenantActiveIngredient/UpdateTenantActiveIngredient`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
