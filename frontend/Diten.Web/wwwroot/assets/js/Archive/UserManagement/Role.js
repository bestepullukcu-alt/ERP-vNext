...
function initRoleDataTable(placeholderText, lanData) {
    ...
    if (dt_role_table) {
        const dt_company = new DataTable(dt_role_table, {
            ajax: {
                url: `${window.ApiBaseUrl}/services/PvTenant/Role/GetRolesByTenantId`,
                method: 'GET',
                dataSrc: 'data'
            },
            columns: [
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            const response = await fetch(`${window.ApiBaseUrl}/services/PvTenant/Role/DeleteRole`, {
                method: 'POST',
                headers: {
...
function initActiveDisableRole() {
    $(document).on('click', '.activate-disabled-record', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvTenant/Role/activate-disable`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
