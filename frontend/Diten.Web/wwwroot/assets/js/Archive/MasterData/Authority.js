...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const url = `${window.ApiBaseUrl}/services/PvTenant/Tenant/GetCountriesByTenantId`;
...
function initAuthorityDataTable(placeholderText, lanData) {
    ...
    if (dt_authority_table) {
        const dt_company = new DataTable(dt_authority_table, {
            ajax: {
                url: `${window.ApiBaseUrl}/services/PvTenant/Authority/GetAuthoritiesByTenantId`,
                method: 'GET',
                dataSrc: 'data',
...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvTenant/Authority/CreateAuthority`, {
            method: 'POST',
            headers: {
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        const userName = window.getUserName();
        try {
            const response = await fetch(`${window.ApiBaseUrl}/services/PvTenant/Authority/DeleteTenantAuthority`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
function handleUpdateFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/services/PvTenant/Authority/UpdateTenantAuthority`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
