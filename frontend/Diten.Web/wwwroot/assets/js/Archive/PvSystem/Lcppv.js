...
function initDataTable(placeholderText, lanData) {
    ...
    if (dt_lcppv_table) {
        const dt_lcppv = new DataTable(dt_lcppv_table, {
            ajax: {
                url: `${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/GetLcppvs`,
                method: 'GET',
                dataSrc: 'data',
...
function bindDeleteRecordEvent() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', async function () {
        ...
        try {
            const response = await fetch(`${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/DeleteLcppv`, {
                method: 'POST',
                headers: {
...
async function updateStatus(id, statusId) {
    ...
    try {
        const response = await fetch(`${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/StatusUpdateLcppv`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
