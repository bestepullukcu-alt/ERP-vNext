...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const statusUrl = `${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/GetLcppvStatus`;
...
function loadQuestionsFromApi(containerId) {
    ...
    fetch(`${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/GetQuestions`)
...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        if (!id) {
            ...
            fetch(`${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/CreateLcppv`, {
                method: 'POST',
                headers: {
            ...
            fetch(`${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/UpdateLcppv`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
async function loadLcppv() {
    ...
    const id = urlParams.get('id');
    const disableStatus = urlParams.get('disabledStatus') ?? 0;
    const response = await fetch(`${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/GetLcppvById/${id}`); // API adresin 
...
function UploadDocument(LcppvId) {
    ...
    fetch(`${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/CreateLcppvDocuments`, {
        method: 'POST',
        body: formUploadData
    })
        .then(response => response.json())
...
function UpdateUploadDocument(LcppvId) {
    ...
    fetch(`${window.ApiBaseUrl}/services/PvOrganization/LcppvMonthlyReconcilation/UpdateLcppvDocuments`, {
        method: 'POST',
        body: formUploadData
    })
        .then(response => response.json())
