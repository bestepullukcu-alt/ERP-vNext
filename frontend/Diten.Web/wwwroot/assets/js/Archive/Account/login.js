...
function handleFormSubmit(fv) {
    fv.on('core.form.valid', function () {
        ...
        fetch(`${window.ApiBaseUrl}/api/PvUser/User/login`, {
            method: 'POST',
            headers: {
        ...
        */
        const fakeToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9." + btoa(JSON.stringify({ "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name": "Bypass User", "image": null })) + ".signature";
        const fakeExpiration = new Date(new Date().getTime() + 24 * 60 * 60 * 1000).toISOString();
