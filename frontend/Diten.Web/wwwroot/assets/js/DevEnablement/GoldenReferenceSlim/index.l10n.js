...
(function () {
    const payload = document.getElementById('goldenreferenceslim-l10n');
    const requiredKeys = [
        ...
        'Name', 'NotAvailable', 'Passive', 'QuickView', 'RecordCreated',
        'RecordDeleted', 'RecordSaved', 'RecordUpdated', 'Reset', 'Save',
        'SaveView', 'Search', 'ShowAll', 'Status', 'Unknown', 'Update',
        'ViewDetails', 'Details', 'ReferenceTypeStandard', 'ReferenceTypeCustom',
        'ReferenceTypePro'
    ];
    ...
    try {
        ...
        console.error('[GoldenReferenceSlim] Localization payload could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
