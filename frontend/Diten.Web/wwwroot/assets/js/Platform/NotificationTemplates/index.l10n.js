...
(function () {
    const payload = document.getElementById('notificationtemplates-l10n');
    const requiredKeys = [
        ...
        'AddNew', 'TemplateKey', 'Locale', 'Channel', 'SemanticVersion', 'UpdatedAt',
        'Scope', 'ScopePlatformDefaults', 'ScopeTenantOverrides', 'TargetTenant', 'SelectTenantFirst',
        'Archive', 'ArchiveConfirm', 'TemplateArchived',
        'StatusDraft', 'StatusActive', 'StatusArchived',
        'ErrorOccurred', 'RecordSaved', 'NotAvailable'
    ];
    ...
    try {
        ...
        console.error('[NotificationTemplates] Localization payload could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
