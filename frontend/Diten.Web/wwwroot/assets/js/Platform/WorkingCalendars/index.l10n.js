...
(function () {
    const payload = document.getElementById('workingcalendars-l10n');
    const requiredKeys = [
        ...
        'CountryCode', 'DayCount', 'Description', 'Details', 'Edit', 'ErrorOccurred',
        ...
        'SaveView', 'Search', 'ShowAll', 'Status', 'StatusActive',
