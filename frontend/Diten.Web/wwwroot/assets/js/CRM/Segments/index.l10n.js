(function (window, document) {
    'use strict';
    let values = {};
    const payload = document.getElementById('segments-l10n');
    try { values = JSON.parse(payload.textContent || '{}'); }
    catch (error) { console.error('[Segments] Localization payload could not be parsed.', error); }
    ...
    window.SegmentsL10n = Object.freeze(values);
})(window, document);
