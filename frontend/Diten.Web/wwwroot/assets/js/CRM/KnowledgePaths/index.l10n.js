(function (window, document) {
    'use strict';
    let values = {};
    const payload = document.getElementById('knowledge-paths-l10n');
    try { values = JSON.parse(payload.textContent || '{}'); }
    catch (error) { console.error('[KnowledgePaths] Localization payload could not be parsed.', error); }
    ...
    window.KnowledgePathsL10n = Object.freeze(values);
})(window, document);
