...
(function () {
    const payload = document.getElementById('requisitions-l10n');
    const requiredKeys = [
        ...
        'FormValidationError', 'Import', 'LevelPrefix', 'RequisitionId', 'LineCount', 'NeedBy',
        'NotAvailable', 'QuickView', 'RecordCreated', 'RecordDeleted', 'RecordSaved',
        'RecordUpdated', 'Reset', 'Save', 'SaveView', 'Search', 'ShowAll', 'Status',
        'StatusDraft', 'StatusSubmitted', 'StatusApproved', 'StatusRejected', 'StatusConverted',
    ...
    try {
        ...
        console.error('[Requisitions] Localization payload could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
