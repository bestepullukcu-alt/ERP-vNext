...
(function () {
    const payload = document.getElementById('purchase-orders-l10n');
    const requiredKeys = [
        ...
        'FormValidationError', 'Import', 'LevelPrefix', 'PoId', 'SupplierId', 'TotalAmount',
        'Currency', 'NotAvailable', 'QuickView', 'RecordCreated', 'RecordDeleted', 'RecordSaved',
        'RecordUpdated', 'Reset', 'Save', 'SaveView', 'Search', 'ShowAll', 'Status',
        'StatusDraft', 'StatusApproved', 'StatusPartiallyReceived', 'StatusReceived', 'StatusClosed',
        'StatusCancelled', 'Update', 'ViewDetails'
    ];
    ...
    try {
        ...
        console.error('[PurchaseOrders] Localization payload could not be parsed.', error);
        window.L10n = window.L10n || {};
        logMissingKeys(window.L10n);
    }
})();
