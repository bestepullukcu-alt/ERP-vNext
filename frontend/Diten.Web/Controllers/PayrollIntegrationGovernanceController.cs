...
{
    private const string BackendSlug = "payroll-integration-governance";

    private readonly HttpClient _httpClient;
    private readonly string _gatewayUrl;
    private readonly ILogger<PayrollIntegrationGovernanceController> _logger;

    public PayrollIntegrationGovernanceController(
        HttpClient httpClient,
        IConfiguration configuration,
        ILogger<PayrollIntegrationGovernanceController> logger)
    {
    ...
    private async Task<IActionResult> ProxyJsonGatewayAsync(HttpMethod method, string targetUrl, bool readBody = false)
    {
        ...
        {
            _logger.LogError(ex, "Platform payroll integration governance proxy request failed for {Method} {TargetUrl}.", method, targetUrl);
