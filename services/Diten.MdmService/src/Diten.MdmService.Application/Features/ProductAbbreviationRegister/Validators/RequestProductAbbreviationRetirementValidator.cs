...
public sealed class RequestProductAbbreviationRetirementValidator
    : AbstractValidator<RequestProductAbbreviationRetirementCommand>
{
    public RequestProductAbbreviationRetirementValidator()
    {
