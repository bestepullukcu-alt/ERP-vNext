...
public sealed class RejectProductAbbreviationAllocationValidator
    : AbstractValidator<RejectProductAbbreviationAllocationCommand>
{
    public RejectProductAbbreviationAllocationValidator()
    {
