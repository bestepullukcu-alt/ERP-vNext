...
public sealed class ApproveProductAbbreviationRetirementValidator
    : AbstractValidator<ApproveProductAbbreviationRetirementCommand>
{
    public ApproveProductAbbreviationRetirementValidator()
    {
