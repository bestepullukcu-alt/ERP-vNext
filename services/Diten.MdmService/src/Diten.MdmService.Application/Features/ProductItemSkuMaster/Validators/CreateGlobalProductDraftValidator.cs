...
public sealed class CreateGlobalProductDraftValidator : AbstractValidator<CreateGlobalProductDraftCommand>
{
    public CreateGlobalProductDraftValidator()
    {
        ...
        When(x => x.Request is not null, () =>
        {
            ...
            RuleFor(x => x.Request.ReservationId).NotEmpty();
