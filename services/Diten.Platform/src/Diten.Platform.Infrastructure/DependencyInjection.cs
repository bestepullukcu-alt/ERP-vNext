...
using Diten.Platform.Infrastructure.Persistence.Repositories.Billing;
...
using Diten.Platform.Infrastructure.Services.ESignature;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration, IHostEnvironment environment)
    {
        ...
        services.AddScoped<IHrisSourceRepository, HrisSourceRepository>();
        services.AddScoped<IPayrollSourceRepository, PayrollSourceRepository>();
        services.AddScoped<ITimeAttendanceProviderRepository, TimeAttendanceProviderRepository>();
        services.AddScoped<IPayrollIntegrationGovernanceRepository, PayrollIntegrationGovernanceRepository>();
        services.AddScoped<IPersonReferenceDirectoryRepository, PersonReferenceDirectoryRepository>();
        ...
        services.AddScoped<IInternalSignatureArtifactStore, InternalSignatureArtifactStore>();
