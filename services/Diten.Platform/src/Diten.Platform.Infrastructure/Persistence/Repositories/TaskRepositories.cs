...
// WP-DM-DCP005-DEADCODE-01 — DocumentReferenceListRepository (DCP-005 slice 2, the CSV document reference
// list) was removed here: its interface (IDocumentReferenceListRepository) had zero live callers, measured
// across the whole repo. document_reference_entries / document_reference_list_versions and the entities that
// map them are UNTOUCHED — this is a dead-code removal, not a schema or data decision.
