...
public sealed record SetOrganizationFieldValueCommand(Guid OrganizationUnitId, SetOrganizationFieldValueRequest Request)
    : IRequest<Response<Guid>>, IAuditableCommand, IAuditMetadataProvider
{
    public AuditRequestMetadata GetAuditMetadata() => new(
        ...
        EntityType: "OrganizationFieldValue", EntityId: OrganizationUnitId, SourceModule: "organization");
}
