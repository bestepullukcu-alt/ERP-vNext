...
public sealed class CreateModuleCatalogItemCommandValidator : ModuleCatalogItemRequestValidator<CreateModuleCatalogItemCommand>
{
    public CreateModuleCatalogItemCommandValidator()
        : base(
