...
public sealed class InvitePlatformAdministratorValidator : AbstractValidator<InvitePlatformAdministratorCommand>
{
    public InvitePlatformAdministratorValidator()
    {
