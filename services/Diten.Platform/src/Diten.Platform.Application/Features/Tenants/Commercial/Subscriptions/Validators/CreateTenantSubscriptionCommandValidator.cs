...
public sealed class CreateTenantSubscriptionCommandValidator : AbstractValidator<CreateTenantSubscriptionCommand>
{
    public CreateTenantSubscriptionCommandValidator()
    {
