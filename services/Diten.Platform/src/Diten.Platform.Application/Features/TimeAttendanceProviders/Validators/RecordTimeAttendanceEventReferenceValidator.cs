...
public sealed class RecordTimeAttendanceEventReferenceValidator : TimeAttendanceEventReferenceRequestValidator<RecordTimeAttendanceEventReferenceCommand>
{
    public RecordTimeAttendanceEventReferenceValidator()
