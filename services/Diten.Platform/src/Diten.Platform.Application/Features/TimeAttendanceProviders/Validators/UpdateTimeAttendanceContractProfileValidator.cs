...
public sealed class UpdateTimeAttendanceContractProfileValidator : TimeAttendanceContractProfileRequestValidator<UpdateTimeAttendanceContractProfileCommand>
{
    public UpdateTimeAttendanceContractProfileValidator()
