...
public sealed record ReplaceBusinessReferenceDataVersionAttributeDefinitionsCommand(
    Guid VersionId,
    string ActorId,
    string CorrelationId,
    string? ExpectedConcurrencyToken,
    IReadOnlyList<BusinessReferenceDataAttributeDefinitionInputModel> Definitions)
    : IRequest<Response<BusinessReferenceDataVersionDetailModel>>, IBusinessReferenceDataRequest, IAuditableCommand, IAuditMetadataProvider
{
    public AuditRequestMetadata GetAuditMetadata() => new(
        ...
        Metadata: new Dictionary<string, object?> { ["governanceEvent"] = "replace_attribute_definitions", ["definitionCount"] = Definitions.Count });
}
