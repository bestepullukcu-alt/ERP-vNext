...
public sealed record ReplaceBusinessReferenceDataVersionMappingsCommand(
    Guid VersionId,
    string ActorId,
    string CorrelationId,
    string? ExpectedConcurrencyToken,
    IReadOnlyList<BusinessReferenceDataMappingInputModel> Mappings)
    : IRequest<Response<BusinessReferenceDataVersionDetailModel>>, IBusinessReferenceDataRequest, IAuditableCommand, IAuditMetadataProvider
{
    public AuditRequestMetadata GetAuditMetadata() => new(
        ...
        Metadata: new Dictionary<string, object?> { ["governanceEvent"] = "replace_mappings", ["mappingCount"] = Mappings.Count });
}
