...
public sealed class GetBusinessReferenceDataHierarchyQueryValidator : AbstractValidator<GetBusinessReferenceDataHierarchyQuery>
{
    public GetBusinessReferenceDataHierarchyQueryValidator()
    {
