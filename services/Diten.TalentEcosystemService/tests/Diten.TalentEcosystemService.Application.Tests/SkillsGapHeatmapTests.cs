...
public sealed class SkillsGapHeatmapTests
{
    ...
    public async Task Create_list_and_get_metadata_contract()
    {
        ...
        var list = await new GetSkillsGapHeatmapReadinessListHandler(repository, new FixedTenantContext(tenantId))
            .Handle(new GetSkillsGapHeatmapReadinessListQuery(), CancellationToken.None);
        var get = await new GetSkillsGapHeatmapReadinessByIdHandler(repository, new FixedTenantContext(tenantId))
    ...
    public async Task Soft_delete_hides_record_and_sets_deleted_at()
    {
        ...
        var handler = new DeleteSkillsGapHeatmapReadinessHandler(repository, new FixedTenantContext(tenantId));
    ...
    public async Task Evaluation_promotes_ready_only_when_metadata_preconditions_are_satisfied()
    {
        ...
        var repository = new InMemorySkillsGapHeatmapReadinessMetadataRepository(metadata);
        var handler = new EvaluateSkillsGapHeatmapReadinessHandler(repository, new FixedTenantContext(tenantId));
    ...
    public async Task Audit_metadata_uses_audit_permission_surface()
    {
        ...
        var metadata = Metadata(tenantId);
        var repository = new InMemorySkillsGapHeatmapReadinessMetadataRepository(metadata);
        var response = await new GetSkillsGapHeatmapAuditMetadataHandler(repository, new FixedTenantContext(tenantId))
    ...
    private sealed class InMemorySkillsGapHeatmapReadinessMetadataRepository : ISkillsGapHeatmapReadinessMetadataRepository
    {
        ...
        public Task<IReadOnlyList<SkillsGapHeatmapReadinessMetadata>> ListAsync(Guid tenantId, CancellationToken ct) =>
        ...
        public Task<SkillsGapHeatmapReadinessMetadata?> GetByIdAsync(Guid tenantId, Guid id, CancellationToken ct) =>
