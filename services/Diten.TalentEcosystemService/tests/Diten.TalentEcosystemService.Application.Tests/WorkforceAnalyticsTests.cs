...
public sealed class WorkforceAnalyticsTests
{
    ...
    public async Task Create_list_and_get_metadata_contract()
    {
        ...
        var list = await new GetWorkforceAnalyticsReadinessListHandler(repository, new FixedTenantContext(tenantId))
            .Handle(new GetWorkforceAnalyticsReadinessListQuery(), CancellationToken.None);
        var get = await new GetWorkforceAnalyticsReadinessByIdHandler(repository, new FixedTenantContext(tenantId))
    ...
    public async Task Soft_delete_hides_record_and_sets_deleted_at()
    {
        ...
        var handler = new DeleteWorkforceAnalyticsReadinessHandler(repository, new FixedTenantContext(tenantId));
    ...
    public async Task Evaluation_promotes_ready_only_when_metadata_preconditions_are_satisfied()
    {
        ...
        var repository = new InMemoryWorkforceAnalyticsReadinessMetadataRepository(metadata);
        var handler = new EvaluateWorkforceAnalyticsReadinessHandler(repository, new FixedTenantContext(tenantId));
    ...
    public async Task Audit_metadata_uses_audit_permission_surface()
    {
        ...
        var metadata = Metadata(tenantId);
        var repository = new InMemoryWorkforceAnalyticsReadinessMetadataRepository(metadata);
        var response = await new GetWorkforceAnalyticsAuditMetadataHandler(repository, new FixedTenantContext(tenantId))
    ...
    private sealed class InMemoryWorkforceAnalyticsReadinessMetadataRepository : IWorkforceAnalyticsReadinessMetadataRepository
    {
        ...
        public Task<IReadOnlyList<WorkforceAnalyticsReadinessMetadata>> ListAsync(Guid tenantId, CancellationToken ct) =>
        ...
        public Task<WorkforceAnalyticsReadinessMetadata?> GetByIdAsync(Guid tenantId, Guid id, CancellationToken ct) =>
