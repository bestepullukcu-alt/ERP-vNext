...
public sealed class CandidateCareerPassportTests
{
    ...
    public async Task Create_list_and_get_metadata_contract()
    {
        ...
        var list = await new GetCandidateCareerPassportReadinessListHandler(repository, new FixedTenantContext(tenantId))
            .Handle(new GetCandidateCareerPassportReadinessListQuery(), CancellationToken.None);
        var get = await new GetCandidateCareerPassportReadinessByIdHandler(repository, new FixedTenantContext(tenantId))
    ...
    public async Task Soft_delete_hides_record_and_sets_deleted_at()
    {
        ...
        var handler = new DeleteCandidateCareerPassportReadinessHandler(repository, new FixedTenantContext(tenantId));
    ...
    public async Task Evaluation_promotes_ready_only_when_metadata_preconditions_are_satisfied()
    {
        ...
        var repository = new InMemoryCandidateCareerPassportReadinessMetadataRepository(metadata);
        var handler = new EvaluateCandidateCareerPassportReadinessHandler(repository, new FixedTenantContext(tenantId));
    ...
    public async Task Audit_metadata_uses_audit_permission_surface()
    {
        ...
        var metadata = Metadata(tenantId);
        var repository = new InMemoryCandidateCareerPassportReadinessMetadataRepository(metadata);
        var response = await new GetCandidateCareerPassportAuditMetadataHandler(repository, new FixedTenantContext(tenantId))
    ...
    private sealed class InMemoryCandidateCareerPassportReadinessMetadataRepository : ICandidateCareerPassportReadinessMetadataRepository
    {
        ...
        public Task<IReadOnlyList<CandidateCareerPassportReadinessMetadata>> ListAsync(Guid tenantId, CancellationToken ct) =>
        ...
        public Task<CandidateCareerPassportReadinessMetadata?> GetByIdAsync(Guid tenantId, Guid id, CancellationToken ct) =>
