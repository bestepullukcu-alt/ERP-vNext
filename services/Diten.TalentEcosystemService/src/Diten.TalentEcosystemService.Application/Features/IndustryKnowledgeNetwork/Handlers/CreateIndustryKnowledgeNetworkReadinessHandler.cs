...
public sealed class CreateIndustryKnowledgeNetworkReadinessHandler : IRequestHandler<CreateIndustryKnowledgeNetworkReadinessCommand, Response<Guid>>
{
    ...
    public CreateIndustryKnowledgeNetworkReadinessHandler(IIndustryKnowledgeNetworkReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
