...
public sealed class CreateVerifiedCertificationRegistryReadinessHandler : IRequestHandler<CreateVerifiedCertificationRegistryReadinessCommand, Response<Guid>>
{
    ...
    public CreateVerifiedCertificationRegistryReadinessHandler(IVerifiedCertificationRegistryReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
