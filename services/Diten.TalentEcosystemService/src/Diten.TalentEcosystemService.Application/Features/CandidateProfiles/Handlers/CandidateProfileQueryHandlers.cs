    ...
    : IRequestHandler<GetCandidateProfileListQuery, Response<IReadOnlyList<CandidateProfileListItemDto>>>
{
    ...
    public GetCandidateProfileListHandler(ITepCandidateProfileMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
    ...
    : IRequestHandler<GetCandidateProfileByIdQuery, Response<CandidateProfileDto>>
{
    ...
    public GetCandidateProfileByIdHandler(ITepCandidateProfileMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
        _repository = repository;
        _tenantContext = tenantContext;
        _legalEntityContext = legalEntityContext;
    ...
    : IRequestHandler<GetCandidateProfileAuditMetadataQuery, Response<CandidateProfileAuditMetadataDto>>
{
    ...
    public GetCandidateProfileAuditMetadataHandler(ITepCandidateProfileMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
        _repository = repository;
        _tenantContext = tenantContext;
        _legalEntityContext = legalEntityContext;
