...
public sealed class CreateSkillsGapHeatmapReadinessHandler : IRequestHandler<CreateSkillsGapHeatmapReadinessCommand, Response<Guid>>
{
    ...
    public CreateSkillsGapHeatmapReadinessHandler(ISkillsGapHeatmapReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
