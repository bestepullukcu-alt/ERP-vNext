...
public sealed class CreateProfessionalReputationLedgerReadinessHandler : IRequestHandler<CreateProfessionalReputationLedgerReadinessCommand, Response<Guid>>
{
    ...
    public CreateProfessionalReputationLedgerReadinessHandler(IProfessionalReputationLedgerReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
