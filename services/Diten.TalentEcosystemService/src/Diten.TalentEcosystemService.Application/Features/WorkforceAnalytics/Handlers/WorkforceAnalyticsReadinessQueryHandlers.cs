    ...
    : IRequestHandler<GetWorkforceAnalyticsReadinessListQuery, Response<IReadOnlyList<WorkforceAnalyticsReadinessListItemDto>>>
{
    ...
    public GetWorkforceAnalyticsReadinessListHandler(IWorkforceAnalyticsReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
    ...
    : IRequestHandler<GetWorkforceAnalyticsReadinessByIdQuery, Response<WorkforceAnalyticsReadinessDto>>
{
    ...
    public GetWorkforceAnalyticsReadinessByIdHandler(IWorkforceAnalyticsReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
        _repository = repository;
        _tenantContext = tenantContext;
    }
    ...
    : IRequestHandler<GetWorkforceAnalyticsAuditMetadataQuery, Response<WorkforceAnalyticsAuditMetadataDto>>
{
    ...
    public GetWorkforceAnalyticsAuditMetadataHandler(IWorkforceAnalyticsReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
        _repository = repository;
        _tenantContext = tenantContext;
    }
