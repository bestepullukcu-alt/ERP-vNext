...
public sealed class DeleteMentorshipRecommendationNetworkReadinessHandler : IRequestHandler<DeleteMentorshipRecommendationNetworkReadinessCommand, Response<bool>>
{
    ...
    public DeleteMentorshipRecommendationNetworkReadinessHandler(IMentorshipRecommendationNetworkReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
