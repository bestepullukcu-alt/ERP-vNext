...
public sealed class CreateMentorshipRecommendationNetworkReadinessHandler : IRequestHandler<CreateMentorshipRecommendationNetworkReadinessCommand, Response<Guid>>
{
    ...
    public CreateMentorshipRecommendationNetworkReadinessHandler(IMentorshipRecommendationNetworkReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
