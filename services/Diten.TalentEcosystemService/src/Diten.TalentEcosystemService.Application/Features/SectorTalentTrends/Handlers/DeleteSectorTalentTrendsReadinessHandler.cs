...
public sealed class DeleteSectorTalentTrendsReadinessHandler : IRequestHandler<DeleteSectorTalentTrendsReadinessCommand, Response<bool>>
{
    ...
    public DeleteSectorTalentTrendsReadinessHandler(ISectorTalentTrendsReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
