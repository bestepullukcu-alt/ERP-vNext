...
public sealed class DeleteEarlyWarningSignalsReadinessHandler : IRequestHandler<DeleteEarlyWarningSignalsReadinessCommand, Response<bool>>
{
    ...
    public DeleteEarlyWarningSignalsReadinessHandler(IEarlyWarningSignalsReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
