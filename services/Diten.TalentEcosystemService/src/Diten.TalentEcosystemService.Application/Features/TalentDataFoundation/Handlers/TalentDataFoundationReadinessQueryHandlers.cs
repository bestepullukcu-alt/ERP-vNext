    ...
    : IRequestHandler<GetTalentDataFoundationReadinessListQuery, Response<IReadOnlyList<TalentDataFoundationReadinessListItemDto>>>
{
    ...
    public GetTalentDataFoundationReadinessListHandler(ITalentDataFoundationReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
    ...
    : IRequestHandler<GetTalentDataFoundationReadinessByIdQuery, Response<TalentDataFoundationReadinessDto>>
{
    ...
    public GetTalentDataFoundationReadinessByIdHandler(ITalentDataFoundationReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
        _repository = repository;
        _tenantContext = tenantContext;
    }
    ...
    : IRequestHandler<GetTalentDataFoundationAuditMetadataQuery, Response<TalentDataFoundationAuditMetadataDto>>
{
    ...
    public GetTalentDataFoundationAuditMetadataHandler(ITalentDataFoundationReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
        _repository = repository;
        _tenantContext = tenantContext;
    }
