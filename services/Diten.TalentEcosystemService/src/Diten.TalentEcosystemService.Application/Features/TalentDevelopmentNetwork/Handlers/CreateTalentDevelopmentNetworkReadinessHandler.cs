...
public sealed class CreateTalentDevelopmentNetworkReadinessHandler : IRequestHandler<CreateTalentDevelopmentNetworkReadinessCommand, Response<Guid>>
{
    ...
    public CreateTalentDevelopmentNetworkReadinessHandler(ITalentDevelopmentNetworkReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
