...
public sealed class DeleteSectorMobilityIntelligenceReadinessHandler : IRequestHandler<DeleteSectorMobilityIntelligenceReadinessCommand, Response<bool>>
{
    ...
    public DeleteSectorMobilityIntelligenceReadinessHandler(ISectorMobilityIntelligenceReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
