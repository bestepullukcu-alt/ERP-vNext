...
public sealed class DeleteIndustryTalentPoolReadinessHandler : IRequestHandler<DeleteIndustryTalentPoolReadinessCommand, Response<bool>>
{
    ...
    public DeleteIndustryTalentPoolReadinessHandler(IIndustryTalentPoolReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
