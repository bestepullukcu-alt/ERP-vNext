...
public sealed class CreateIndustrySkillPassportReadinessHandler : IRequestHandler<CreateIndustrySkillPassportReadinessCommand, Response<Guid>>
{
    ...
    public CreateIndustrySkillPassportReadinessHandler(IIndustrySkillPassportReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
