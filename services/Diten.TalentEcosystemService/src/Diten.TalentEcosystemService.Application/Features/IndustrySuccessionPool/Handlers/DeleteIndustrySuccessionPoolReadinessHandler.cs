...
public sealed class DeleteIndustrySuccessionPoolReadinessHandler : IRequestHandler<DeleteIndustrySuccessionPoolReadinessCommand, Response<bool>>
{
    ...
    public DeleteIndustrySuccessionPoolReadinessHandler(IIndustrySuccessionPoolReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
