...
public sealed class DeleteTalentSupplyDemandForecastingReadinessHandler : IRequestHandler<DeleteTalentSupplyDemandForecastingReadinessCommand, Response<bool>>
{
    ...
    public DeleteTalentSupplyDemandForecastingReadinessHandler(ITalentSupplyDemandForecastingReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
