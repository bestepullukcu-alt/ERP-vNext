...
public sealed class CreatePayBenchmarkingReadinessHandler : IRequestHandler<CreatePayBenchmarkingReadinessCommand, Response<Guid>>
{
    ...
    public CreatePayBenchmarkingReadinessHandler(IPayBenchmarkingReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
