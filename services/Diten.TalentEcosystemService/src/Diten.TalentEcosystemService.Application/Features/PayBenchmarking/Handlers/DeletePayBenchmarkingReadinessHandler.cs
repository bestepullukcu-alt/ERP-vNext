...
public sealed class DeletePayBenchmarkingReadinessHandler : IRequestHandler<DeletePayBenchmarkingReadinessCommand, Response<bool>>
{
    ...
    public DeletePayBenchmarkingReadinessHandler(IPayBenchmarkingReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
