...
public sealed record TenantEntitlementDisabledV1 : IInternalEvent
{
    public const string Name = "tenant.entitlement.disabled.v1";
    public const int Version = 1;

    public TenantEntitlementDisabledV1(
        Guid eventId,
