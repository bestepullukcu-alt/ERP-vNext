...
public sealed record TenantEntitlementExpiryUpdatedV1 : IInternalEvent
{
    public const string Name = "tenant.entitlement.expiryupdated.v1";
    public const int Version = 1;

    public TenantEntitlementExpiryUpdatedV1(
        Guid eventId,
