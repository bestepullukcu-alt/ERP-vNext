...
public sealed record TenantEntitlementOverrideRemovedV1 : IInternalEvent
{
    public const string Name = "tenant.entitlement.overrideremoved.v1";
    public const int Version = 1;

    public TenantEntitlementOverrideRemovedV1(
        Guid eventId,
