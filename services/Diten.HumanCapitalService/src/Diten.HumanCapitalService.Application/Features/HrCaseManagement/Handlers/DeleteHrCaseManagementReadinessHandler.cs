...
public sealed class DeleteHrCaseManagementReadinessHandler : IRequestHandler<DeleteHrCaseManagementReadinessCommand, Response<bool>>
{
    ...
    public DeleteHrCaseManagementReadinessHandler(IHrCaseManagementReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
