...
public sealed class DeleteLearningTrainingReadinessHandler : IRequestHandler<DeleteLearningTrainingReadinessCommand, Response<bool>>
{
    ...
    public DeleteLearningTrainingReadinessHandler(ILearningTrainingReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
