...
public sealed class DeleteHrKpiAnalyticsReadinessHandler : IRequestHandler<DeleteHrKpiAnalyticsReadinessCommand, Response<bool>>
{
    ...
    public DeleteHrKpiAnalyticsReadinessHandler(IHrKpiAnalyticsReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
