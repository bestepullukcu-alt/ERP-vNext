...
public sealed class CreateEmploymentChangeReadinessHandler : IRequestHandler<CreateEmploymentChangeReadinessCommand, Response<Guid>>
{
    ...
    public CreateEmploymentChangeReadinessHandler(IEmploymentChangeReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
