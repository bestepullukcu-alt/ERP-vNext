...
public sealed class CreateWorkforcePlanningReadinessHandler : IRequestHandler<CreateWorkforcePlanningReadinessCommand, Response<Guid>>
{
    ...
    public CreateWorkforcePlanningReadinessHandler(IWorkforcePlanningReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
