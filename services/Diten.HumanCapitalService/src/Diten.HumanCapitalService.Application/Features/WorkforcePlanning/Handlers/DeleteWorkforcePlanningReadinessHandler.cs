...
public sealed class DeleteWorkforcePlanningReadinessHandler : IRequestHandler<DeleteWorkforcePlanningReadinessCommand, Response<bool>>
{
    ...
    public DeleteWorkforcePlanningReadinessHandler(IWorkforcePlanningReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
