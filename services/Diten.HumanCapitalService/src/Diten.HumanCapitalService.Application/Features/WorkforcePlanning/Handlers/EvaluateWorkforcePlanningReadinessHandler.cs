...
public sealed class EvaluateWorkforcePlanningReadinessHandler : IRequestHandler<EvaluateWorkforcePlanningReadinessCommand, Response<WorkforcePlanningReadinessDto>>
{
    ...
    public EvaluateWorkforcePlanningReadinessHandler(IWorkforcePlanningReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
