...
public sealed class DeleteDevelopmentPlanReadinessHandler : IRequestHandler<DeleteDevelopmentPlanReadinessCommand, Response<bool>>
{
    ...
    public DeleteDevelopmentPlanReadinessHandler(IDevelopmentPlanReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
