...
public sealed class DeleteCandidatePipelineReadinessHandler
    : IRequestHandler<DeleteCandidatePipelineReadinessCommand, Response<bool>>
{
    ...
    public async Task<Response<bool>> Handle(DeleteCandidatePipelineReadinessCommand request, CancellationToken ct)
    {
        ...
        entity.PipelineReadinessState = CandidatePipelineReadinessState.Archived;
