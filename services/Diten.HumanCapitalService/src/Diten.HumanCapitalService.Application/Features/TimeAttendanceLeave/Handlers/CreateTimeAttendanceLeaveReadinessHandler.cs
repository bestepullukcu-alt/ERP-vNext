...
public sealed class CreateTimeAttendanceLeaveReadinessHandler : IRequestHandler<CreateTimeAttendanceLeaveReadinessCommand, Response<Guid>>
{
    ...
    public CreateTimeAttendanceLeaveReadinessHandler(ITimeAttendanceLeaveReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
