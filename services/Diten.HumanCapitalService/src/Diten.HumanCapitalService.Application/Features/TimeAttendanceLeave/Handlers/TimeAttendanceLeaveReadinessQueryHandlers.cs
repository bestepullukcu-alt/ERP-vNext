    ...
    : IRequestHandler<GetTimeAttendanceLeaveReadinessListQuery, Response<IReadOnlyList<TimeAttendanceLeaveReadinessListItemDto>>>
{
    ...
    public GetTimeAttendanceLeaveReadinessListHandler(ITimeAttendanceLeaveReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
    ...
    : IRequestHandler<GetTimeAttendanceLeaveReadinessByIdQuery, Response<TimeAttendanceLeaveReadinessDto>>
{
    ...
    public GetTimeAttendanceLeaveReadinessByIdHandler(ITimeAttendanceLeaveReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
        _repository = repository;
        _tenantContext = tenantContext;
    }
    ...
    : IRequestHandler<GetTimeAttendanceLeaveAuditMetadataQuery, Response<TimeAttendanceLeaveAuditMetadataDto>>
{
    ...
    public GetTimeAttendanceLeaveAuditMetadataHandler(ITimeAttendanceLeaveReadinessMetadataRepository repository, ITenantContext tenantContext)
    {
        _repository = repository;
        _tenantContext = tenantContext;
    }
