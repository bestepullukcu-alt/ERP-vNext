...
public sealed class CreateHrComplianceReadinessHandler : IRequestHandler<CreateHrComplianceReadinessCommand, Response<Guid>>
{
    ...
    public CreateHrComplianceReadinessHandler(IHrComplianceReadinessMetadataRepository repository, ITenantContext tenantContext, ILegalEntityContext legalEntityContext)
    {
