...
public sealed class UpdateGoldenReferenceCompactValidator : AbstractValidator<UpdateGoldenReferenceCompactCommand>
{
    public UpdateGoldenReferenceCompactValidator()
    {
