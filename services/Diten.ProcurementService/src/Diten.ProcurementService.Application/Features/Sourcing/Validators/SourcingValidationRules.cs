...
/// <summary>
/// Ortak validation yardımcıları (MOD-0145 §8/§12). Parasal/miktar alanları Decimal string (^-?\d+(\.\d+)?$);
/// float YASAK — string kalır, serileştirmede float'a dönmez.
/// </summary>
internal static partial class SourcingValidationRules
{
    [GeneratedRegex(@"^-?\d+(\.\d+)?$")]
