...
public sealed class CreateInitiativeSuccessorValidator : AbstractValidator<CreateInitiativeSuccessorCommand>
{
    public CreateInitiativeSuccessorValidator()
    {
        ...
        RuleFor(x => x.ExpectedTerminalVersion).GreaterThan(0);
