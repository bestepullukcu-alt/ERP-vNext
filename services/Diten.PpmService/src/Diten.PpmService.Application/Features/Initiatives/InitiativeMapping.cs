...
{
    internal static InitiativeV2Dto ToV2Dto(this Initiative x) => new(x.Id, x.Code, x.Name, x.Description,
        x.PortfolioId, x.InitiativeTypeCode, x.PriorityCode, x.PlannedStartDate, x.PlannedEndDate,
        x.LifecycleState, x.SupersedesInitiativeId, x.IsReferenceable, x.Version);
