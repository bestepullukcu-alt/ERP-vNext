...
{
    internal static PortfolioDto ToDto(this Portfolio x) => new(x.Id, x.Code, x.Name, x.Description, x.LifecycleState, null, x.IsReferenceable, x.Version) { CapacityAllocationDescription = x.CapacityAllocationDescription };
