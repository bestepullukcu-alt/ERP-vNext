...
**Durum:** **M0 FOUNDATION + M1 PİLOT TAMAM** ✅ — M0.1–M0.7 (7 çekirdek modül) · **M1 pilot `:feature:applicant-intake`** (fbbd816a) CT-ACCEPTED + commit (2026-09-11). **8 modül, 105 mobil unit test yeşil, R8 release ~2.0MB.** Sonraki: **M1 rollout — kalan 22 HR modülü** (pilot şablonundan klonla; her biri kendi Room DB + `@IntoSet SyncHandler` + list/create/detail + permission-gate).
