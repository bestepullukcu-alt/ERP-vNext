...
**Durum:** BAŞLADI — **M0.1** (5ae82588) · **M0.2 `:core:network`** (f256df89) · **M0.3+M0.5** (0456e913, paralel) · **M0.4 `:core:auth`** (265959b8) CT-ACCEPTED + commit (2026-09-11). Sonraki: **M0.6** (`:core:sync` + `:core:common` genişletme), sonra **M0.7 `:app` shell** (login UI + legal-entity switcher + permission-gated menü + dashboard) → M1 pilot. **6 modül, 53 mobil unit test yeşil.**
