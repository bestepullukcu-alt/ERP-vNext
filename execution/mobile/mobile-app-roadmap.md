...
**Durum:** BAŞLADI — **M0.1** (5ae82588) · **M0.2 network** (f256df89) · **M0.3+M0.5** (0456e913) · **M0.4 auth** (265959b8) · **M0.6 `:core:sync`+`:core:common` MVI** (ab25b8ef) CT-ACCEPTED + commit (2026-09-11). **M0 çekirdek TAMAM.** Sonraki: **M0.7 `:app` shell** (WorkManager app-init + login UI + legal-entity switcher + permission-gated menü + dashboard) → **ilk çalışır/görsel uygulama** → M1 pilot. **7 modül, 76 mobil unit test yeşil.**
