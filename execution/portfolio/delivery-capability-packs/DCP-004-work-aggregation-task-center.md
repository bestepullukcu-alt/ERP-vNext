...
> **Superseded 2026-09-15 (owner decision, BL-410 / BL-417 — see §"Decision amendment 2026-09-15" at the end of this pack).** Measured: entitlement reached only the tenant Admin role and was never an API security wall; the Work Center inbox is now available to every tenant user.
