...
status_note: "Promoted draft → approved by AG-STEP-002 after read-only verification (verify_module_id.py --check-all exit 0, 0 hard violations; deprecated-alias chains resolve; CAND-CAP-0001…0005 recorded). HCM/TEP extension records CAND-CAP-0006, CAND-CAP-0007, CAND-CAP-0008, CAND-CAP-0009, CAND-CAP-0010, CAND-CAP-0011, CAND-CAP-0012, CAND-CAP-0013, CAND-CAP-0014, CAND-CAP-0015, CAND-CAP-0016, CAND-CAP-0017, CAND-CAP-0018, CAND-CAP-0019, CAND-CAP-0020, CAND-CAP-0021, and CAND-CAP-0022 as EA/registry-owner-approved temporary governance identities for HR Capability Block Shell, Employee Profile & Employment Record Projection, HR Governance & Sensitive Access Controls, Position & Organization Assignment, Offboarding & Exit Management, Talent Ecosystem Platform Shell, Association Membership & Member Company Registry, Consent, Visibility & Access Policy, Verified HR Participant & Company Access, Talent Ecosystem Governance & Review Board, Trust Level & Multi-Signature Engine, Industry Candidate Identity & Talent Profile, Industry Exit Reference Record Registry, Reference Exchange Marketplace, Rehire Recommendation Network, Candidate Response & Dispute Management, and Recruitment / Applicant Intake."
---
...
The §16 items have been resolved in a second governance pass and are no longer "pending unresolved": each was mapped to an existing Blueprint MOD (`PSS-011 → MOD-0048`, `MOD-0266`/`MOD-0008` name-aligned, `PSS-XCUT-SV → MOD-0287`), an FU under a Blueprint parent (`PSS-004 → MOD-0017-FU01`, `NEW-003 → MOD-0027-FU02`), retired (`MOD-0169`), or a temporary `CAND-CAP-####` candidate (governance-only): `CAND-CAP-0001` (Tenant User / Identity Foundation), `CAND-CAP-0002` (SaaS Subscription, Plan & Entitlement Management; +FU01–FU05), `CAND-CAP-0003` (Platform Administration & Operations; +FU01/FU02), `CAND-CAP-0004` (Tenant Impersonation / Support Tooling), `CAND-CAP-0005` (SaaS Billing & Invoicing). Later EA/registry-owner HCM/TEP reservations add `CAND-CAP-0006` (HR Capability Block Shell), `CAND-CAP-0007` (Employee Profile & Employment Record Projection), `CAND-CAP-0008` (HR Governance & Sensitive Access Controls), `CAND-CAP-0009` (Position & Organization Assignment), `CAND-CAP-0010` (Offboarding & Exit Management), `CAND-CAP-0011` (Talent Ecosystem Platform Shell), `CAND-CAP-0012` (Association Membership & Member Company Registry), `CAND-CAP-0013` (Consent, Visibility & Access Policy), `CAND-CAP-0014` (Verified HR Participant & Company Access), `CAND-CAP-0015` (Talent Ecosystem Governance & Review Board), `CAND-CAP-0016` (Trust Level & Multi-Signature Engine), `CAND-CAP-0017` (Industry Candidate Identity & Talent Profile), `CAND-CAP-0018` (Industry Exit Reference Record Registry), `CAND-CAP-0019` (Reference Exchange Marketplace), `CAND-CAP-0020` (Rehire Recommendation Network), `CAND-CAP-0021` (Candidate Response & Dispute Management), and `CAND-CAP-0022` (Recruitment / Applicant Intake) as temporary governance identities because the Excel/DCP-008 `MOD-0297`, `MOD-0298`, and `MOD-0299` proposals collide with retained platform alias chains, while `MOD-0314`, `MOD-0305`, `MOD-0300`, `MOD-0321`, `MOD-0322`, `MOD-0323`, `MOD-0324`, `MOD-0325`, `MOD-0326`, `MOD-0327`, `MOD-0328`, `MOD-0329`, `MOD-0330`, and `MOD-0331` are absent from the Blueprint/registry. `MOD-0288`, `MOD-0288-FU01`, and `MOD-0288-FU02` remain PSS directory/reference substrate only and are not reused as the HCM-native assignment identity; `CAND-CAP-0007`, `CAND-CAP-0008`, and `CAND-CAP-0009` remain HCM foundation dependencies only and are not reused as the offboarding identity; `CAND-CAP-0010` may provide local/deferred handoff metadata but does not authorize TEP runtime; `CAND-CAP-0011` remains the completed TEP Shell dependency for `CAND-CAP-0012`; `CAND-CAP-0013` defines the policy boundary needed before CAND-CAP-0012 Association runtime can become ready-for-dev; `CAND-CAP-0014` defines verified HR participant and company access preconditions; `CAND-CAP-0015` defines the TEP governance/review-board boundary; `CAND-CAP-0016` defines the TEP trust/multi-signature boundary; `CAND-CAP-0017` defines the TEP candidate identity/talent profile boundary; `CAND-CAP-0018` defines the TEP industry exit reference record registry boundary; `CAND-CAP-0019` defines the TEP reference exchange marketplace boundary; `CAND-CAP-0020` defines the TEP rehire recommendation network boundary; `CAND-CAP-0021` defines the TEP candidate response/dispute boundary; `CAND-CAP-0022` defines the HCM recruitment/applicant intake boundary; `MOD-0022` remains PSS e-signature substrate only; and `MOD-0018` remains PSS RBAC/ABAC substrate only. The remaining truly-pending decision is the future Enterprise Architect allocation of canonical `MOD-xxxx` for `CAND-CAP-0001…0022`. Runtime literals `MOD-0297` / `MOD-0299` are retained as legacy runtime compatibility literals; candidate IDs are never written into runtime code.
