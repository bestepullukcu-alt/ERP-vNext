...
| `services/Diten.Platform/src/Diten.Platform.Infrastructure/Services/Mdm/MdmLegalEntityReferenceValidator.cs:33-80`; `services/Diten.Platform/src/Diten.Platform.Infrastructure/Services/Http/TenantPropagationHandler.cs:16-24`; `services/Diten.Platform/tests/Diten.Platform.Application.Tests/TenantOrganization/MdmLegalEntityReferenceValidatorTests.cs:15-105` | Platform provides a reusable caller-JWT/tenant-propagation and fail-closed consumer example, including network/malformed-payload tests, but it is not proof of a dedicated MOD-0290 service/delegated identity, least-privilege credential or SLA contract |
