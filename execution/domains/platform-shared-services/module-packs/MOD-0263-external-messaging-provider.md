...
- Migration of existing Auth/Platform invitation/password reset/MFA email senders (tracked in `docs/records/audits/2026-05/mod-0027-email-migration-inventory.md` — separate migration pack required).
...
- [ ] Migration of existing Auth/Platform ad-hoc email senders (A1/A2/P1/P2 in `docs/records/audits/2026-05/mod-0027-email-migration-inventory.md`) is **NOT** performed by MOD-0263 and remains owned by a future migration pack.
...
- Hand-off to a dedicated migration pack covering A1/A2/P1/P2 from `docs/records/audits/2026-05/mod-0027-email-migration-inventory.md`.
