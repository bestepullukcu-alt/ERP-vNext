...
status: draft
owner: ai-agent
branch: feature/mdm/mdm-050-order-capture
started: 2026-04-15
target: 2026-06-30
---

# MDM-050 — Order Capture

## Module Summary
- Source module: `MOD-0168`
- Suggested wave: `W2`
- Source stream: `SRC - Inventory Reserva; SRC - Sales O2C`
- Bootstrap note: Ek not bulunmuyor.

## Ownership and Boundaries
- Bu paket, `Order Capture` modülünün domain içi kapsamını tanımlar.
...
## Repo Scope
- `execution/domains/master-data-management/module-packs/MDM-050-order-capture.md`
...
## Acceptance Criteria
- [ ] `Order Capture` için modül sınırları ve sahiplik kapsamı netleştirildi.
- [ ] Bağımlılık kapıları (`dependency_gates`) planlama board'una işlendi.
- [ ] Sayfa planı `1. MOD-0168 Order Capture Overview` (Overview / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `2. MOD-0168 Order Capture Catalog` (Search & Filters / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `3. MOD-0168 Order Capture Detail` (Header Summary / Overview) için kapsam netleştirildi.
- [ ] Sayfa planı `1. Order Binding (MOD-0168) Overview` (Overview / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `2. Order Binding (MOD-0168) Catalog` (Search & Filters / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `3. Order Binding (MOD-0168) Detail` (Header Summary / Overview) için kapsam netleştirildi.
...
- Kaynak kimlik: `MOD-0168` → hedef paket kimlik: `MDM-050`.
