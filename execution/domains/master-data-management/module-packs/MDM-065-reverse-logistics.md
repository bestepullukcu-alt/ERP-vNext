...
status: draft
owner: ai-agent
branch: feature/mdm/mdm-065-reverse-logistics
started: 2026-04-15
target: 2026-06-30
---

# MDM-065 — Reverse Logistics

## Module Summary
- Source module: `MOD-0186`
- Suggested wave: `W2`
- Source stream: `SRC - Logistics`
- Bootstrap note: Ek not bulunmuyor.

## Ownership and Boundaries
- Bu paket, `Reverse Logistics` modülünün domain içi kapsamını tanımlar.
...
## Repo Scope
- `execution/domains/master-data-management/module-packs/MDM-065-reverse-logistics.md`
...
## Acceptance Criteria
- [ ] `Reverse Logistics` için modül sınırları ve sahiplik kapsamı netleştirildi.
- [ ] Bağımlılık kapıları (`dependency_gates`) planlama board'una işlendi.
- [ ] Sayfa planı `1. MOD-0186 Reverse Logistics Overview` (Overview / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `2. MOD-0186 Reverse Logistics Catalog` (Search & Filters / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `3. MOD-0186 Reverse Logistics Detail` (Header Summary / Overview) için kapsam netleştirildi.
...
- Kaynak kimlik: `MOD-0186` → hedef paket kimlik: `MDM-065`.
