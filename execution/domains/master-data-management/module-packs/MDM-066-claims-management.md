...
status: draft
owner: ai-agent
branch: feature/mdm/mdm-066-claims-management
started: 2026-04-15
target: 2026-06-30
---

# MDM-066 — Claims Management

## Module Summary
- Source module: `MOD-0187`
- Suggested wave: `W2`
- Source stream: `SRC - Logistics`
- Bootstrap note: Ek not bulunmuyor.

## Ownership and Boundaries
- Bu paket, `Claims Management` modülünün domain içi kapsamını tanımlar.
...
## Repo Scope
- `execution/domains/master-data-management/module-packs/MDM-066-claims-management.md`
...
## Acceptance Criteria
- [ ] `Claims Management` için modül sınırları ve sahiplik kapsamı netleştirildi.
- [ ] Bağımlılık kapıları (`dependency_gates`) planlama board'una işlendi.
- [ ] Sayfa planı `1. Claims hard gate (MOD-0187) Overview` (Overview / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `2. Claims hard gate (MOD-0187) Catalog` (Search & Filters / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `3. Claims hard gate (MOD-0187) Detail` (Header Summary / Overview) için kapsam netleştirildi.
- [ ] Sayfa planı `1. MOD-0187 Claims Management Overview` (Overview / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `2. MOD-0187 Claims Management Catalog` (Search & Filters / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `3. MOD-0187 Claims Management Detail` (Header Summary / Overview) için kapsam netleştirildi.
...
- Kaynak kimlik: `MOD-0187` → hedef paket kimlik: `MDM-066`.
