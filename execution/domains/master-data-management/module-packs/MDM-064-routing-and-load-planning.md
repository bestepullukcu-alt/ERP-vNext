...
status: draft
owner: ai-agent
branch: feature/mdm/mdm-064-routing-and-load-planning
started: 2026-04-15
target: 2026-06-30
---

# MDM-064 — Routing & Load Planning

## Module Summary
- Source module: `MOD-0185`
- Suggested wave: `W2`
- Source stream: `SRC - Logistics`
- Bootstrap note: Ek not bulunmuyor.

## Ownership and Boundaries
- Bu paket, `Routing & Load Planning` modülünün domain içi kapsamını tanımlar.
...
## Repo Scope
- `execution/domains/master-data-management/module-packs/MDM-064-routing-and-load-planning.md`
...
## Acceptance Criteria
- [ ] `Routing & Load Planning` için modül sınırları ve sahiplik kapsamı netleştirildi.
- [ ] Bağımlılık kapıları (`dependency_gates`) planlama board'una işlendi.
- [ ] Sayfa planı `1. MOD-0185 Routing & Load Planning Overview` (Overview / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `2. MOD-0185 Routing & Load Planning Catalog` (Search & Filters / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `3. MOD-0185 Routing & Load Planning Detail` (Header Summary / Overview) için kapsam netleştirildi.
...
- Kaynak kimlik: `MOD-0185` → hedef paket kimlik: `MDM-064`.
