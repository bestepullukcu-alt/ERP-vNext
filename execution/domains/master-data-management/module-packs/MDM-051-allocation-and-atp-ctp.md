---
id: MDM-051
name: Allocation & ATP/CTP
domain: master-data-management
status: draft
owner: ai-agent
branch: feature/mdm/mdm-051-allocation-and-atp-ctp
started: 2026-04-15
target: 2026-06-30
---

# MDM-051 — Allocation & ATP/CTP

## Module Summary
- Source module: `MOD-0172`
- Suggested wave: `W2`
- Source stream: `SRC - Inventory; SRC - Inventory Reserva; SRC - Sales O2C`
- Bootstrap note: Ek not bulunmuyor.

## Ownership and Boundaries
- Bu paket, `Allocation & ATP/CTP` modülünün domain içi kapsamını tanımlar.
...
## Repo Scope
- `execution/domains/master-data-management/module-packs/MDM-051-allocation-and-atp-ctp.md`
...
## Acceptance Criteria
- [ ] `Allocation & ATP/CTP` için modül sınırları ve sahiplik kapsamı netleştirildi.
- [ ] Bağımlılık kapıları (`dependency_gates`) planlama board'una işlendi.
- [ ] Sayfa planı `1. Availability Feed to Promise Layer (MOD-0172) Overview` (Overview / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `2. Availability Feed to Promise Layer (MOD-0172) Catalog` (Search & Filters / Filters) için kapsam netleştirildi.
- [ ] Sayfa planı `3. Availability Feed to Promise Layer (MOD-0172) Detail` (Header Summary / Overview) için kapsam netleştirildi.
...
- Kaynak kimlik: `MOD-0172` → hedef paket kimlik: `MDM-051`.
