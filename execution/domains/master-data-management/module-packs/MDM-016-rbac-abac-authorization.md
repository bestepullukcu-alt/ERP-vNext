...
status: draft
owner: ai-agent
branch: feature/mdm/mdm-016-rbac-abac-authorization
started: 2026-04-15
target: 2026-06-30
---

# MDM-016 — RBAC / ABAC Authorization

## Module Summary
- Source module: `MOD-0018`
- Suggested wave: `W1`
- Source stream: `SRC - Back Bone`
- Bootstrap note: Authorization baseline for workflows, approvals, and consoles.

## Ownership and Boundaries
- Bu paket, `RBAC / ABAC Authorization` modülünün domain içi kapsamını tanımlar.
...
## Repo Scope
- `execution/domains/master-data-management/module-packs/MDM-016-rbac-abac-authorization.md`
...
## Acceptance Criteria
- [ ] `RBAC / ABAC Authorization` için modül sınırları ve sahiplik kapsamı netleştirildi.
...
- Kaynak kimlik: `MOD-0018` → hedef paket kimlik: `MDM-016`.
