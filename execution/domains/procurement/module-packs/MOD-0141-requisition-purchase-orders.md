...
> **Status guard.** `ready-for-dev` — DCP-010 `approved` (Ali, 2026-09-16) + bu pack `ready-for-dev` (Ali, 2026-09-16) → kod yetkili (CAP-001 §7). runtime_code_allowed bu modül için AÇIK. DCP-010 §8 sırasında **üçüncü** dilim (0140 done → 0145 done → **0141 aktif** → 0142 → 0143 → 0144).
