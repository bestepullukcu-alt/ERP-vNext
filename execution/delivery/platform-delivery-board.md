...
| **WIP-MOD-0263-messaging-adapters** | MOD-0263 | Feature | Section 9.1 | SMTP/MailKit Batch 1 external messaging adapter evidence; SendGrid/failover/bounce webhooks remain deferred | review | Medium | Antigravity / Gemini | `orchestrator` | 2026-08-07 | TBD | Live SMTP smoke pending approved SMTP catcher, tenant settings, secret-reference, and cleanup plan | Run approved live SMTP smoke before marking MOD-0263 done |
