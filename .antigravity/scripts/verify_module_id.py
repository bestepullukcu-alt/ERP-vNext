...
The Blueprint workbook
    docs/blueprint/System Capability & Implementation Blueprint - master 8.1.xlsx :: Blueprint_Data
...
BLUEPRINT = "docs/blueprint/System Capability & Implementation Blueprint - master 8.1.xlsx"
