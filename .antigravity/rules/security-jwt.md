...
- **Permission-Based Access:** Sadece giriş yapmış olmak yetmez; her işlem kullanıcının sahip olduğu `Permission` (Yetki Anahtarı) ile denetlenmelidir (Örn: `[HasPermission("module.sample-module.delete")]`).
