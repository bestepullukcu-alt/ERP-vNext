...
- **5011–5063**: Microservice bandı (Backend servis portları) — band 5060'tan 5063'e genişletildi (CT kararı 2026-09-14; HumanCapitalService=5063 kurtarma servisi için).
...
| **Diten.HumanCapitalService.Api** | `5063` | HCM readiness — applicant intake, onboarding, competency/development. ⚠ Bandın **son portu** (band 5063'e genişletildi — CT kararı 2026-09-14). |
