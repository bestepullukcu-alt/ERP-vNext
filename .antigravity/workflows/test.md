...
4. **9 Dil Check:** Hata mesajlarının `SharedLocalizer` üzerinden doğru Key ile dönüp dönmediği kontrol edilmelidir.
...
| Boş isim hatası (9 dil) dönmeli | Validation | L10n |
